	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001bd:	e8 ce 1a 00 00       	call   801c90 <__udivdi3>
  ...
  8001fb:	e8 a0 1b 00 00       	call   801da0 <__umoddi3>
  800200:	83 c4 14             	add    $0x14,%esp
  800203:	0f be 80 28 1f 80 00 	movsbl 0x801f28(%eax),%eax
  80020a:	50                   	push   %eax
...
0080025a <vprintfmt>:
{
  ...
  8002aa:	3e ff 24 85 60 20 80 	notrack jmp *0x802060(,%eax,4)
  8002b1:	00 
  ...
  800377:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  80037e:	85 d2                	test   %edx,%edx
  800380:	74 18                	je     80039a <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800382:	52                   	push   %edx
  800383:	68 f1 22 80 00       	push   $0x8022f1
  800388:	53                   	push   %ebx
  800389:	56                   	push   %esi
  ...
  80039a:	50                   	push   %eax
  80039b:	68 40 1f 80 00       	push   $0x801f40
  8003a0:	53                   	push   %ebx
  8003a1:	56                   	push   %esi
  ...
  8003c2:	b8 39 1f 80 00       	mov    $0x801f39,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b4c:	68 1f 22 80 00       	push   $0x80221f
  800b51:	6a 23                	push   $0x23
  800b53:	68 3c 22 80 00       	push   $0x80223c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bd9:	68 1f 22 80 00       	push   $0x80221f
  800bde:	6a 23                	push   $0x23
  800be0:	68 3c 22 80 00       	push   $0x80223c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c65:	68 1f 22 80 00       	push   $0x80221f
  800c6a:	6a 23                	push   $0x23
  800c6c:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cab:	68 1f 22 80 00       	push   $0x80221f
  800cb0:	6a 23                	push   $0x23
  800cb2:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cf1:	68 1f 22 80 00       	push   $0x80221f
  800cf6:	6a 23                	push   $0x23
  800cf8:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d37:	68 1f 22 80 00       	push   $0x80221f
  800d3c:	6a 23                	push   $0x23
  800d3e:	68 3c 22 80 00       	push   $0x80223c
...
sys_ipc_recv(void *dstva)
{
  ...
  800da3:	68 1f 22 80 00       	push   $0x80221f
  800da8:	6a 23                	push   $0x23
  800daa:	68 3c 22 80 00       	push   $0x80223c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e9a:	ba c8 22 80 00       	mov    $0x8022c8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800ebc:	51                   	push   %ecx
  800ebd:	50                   	push   %eax
  800ebe:	68 4c 22 80 00       	push   $0x80224c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80112a:	53                   	push   %ebx
  80112b:	50                   	push   %eax
  80112c:	68 8d 22 80 00       	push   $0x80228d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011fb:	53                   	push   %ebx
  8011fc:	50                   	push   %eax
  8011fd:	68 a9 22 80 00       	push   $0x8022a9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012ab:	53                   	push   %ebx
  8012ac:	50                   	push   %eax
  8012ad:	68 6c 22 80 00       	push   $0x80226c
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013a3:	e8 08 08 00 00       	call   801bb0 <ipc_send>
  ...
  8013c1:	e8 44 08 00 00       	call   801c0a <ipc_find_env>
...
00801481 <devfile_write>:
{
  ...
  80148e:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801493:	ba f8 0f 00 00       	mov    $0xff8,%edx
  801498:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  80149b:	8b 55 08             	mov    0x8(%ebp),%edx
  80149e:	8b 52 0c             	mov    0xc(%edx),%edx
  8014a1:	89 15 00 50 80 00    	mov    %edx,0x805000
...
008014cb <devfile_read>:
{
  ...
  801524:	c3                   	ret    
	assert(r <= n);
  801525:	68 d8 22 80 00       	push   $0x8022d8
  80152a:	68 df 22 80 00       	push   $0x8022df
  80152f:	6a 7d                	push   $0x7d
  801531:	68 f4 22 80 00       	push   $0x8022f4
  801536:	e8 be 05 00 00       	call   801af9 <_panic>
	assert(r <= PGSIZE);
  80153b:	68 ff 22 80 00       	push   $0x8022ff
  801540:	68 df 22 80 00       	push   $0x8022df
  801545:	6a 7e                	push   $0x7e
  801547:	68 f4 22 80 00       	push   $0x8022f4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80161a:	68 0b 23 80 00       	push   $0x80230b
  80161f:	53                   	push   %ebx
...
0080167e <_pipeisclosed>:
{
  ...
  801696:	57                   	push   %edi
  801697:	e8 ab 05 00 00       	call   801c47 <pageref>
  80169c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  80169f:	89 34 24             	mov    %esi,(%esp)
  8016a2:	e8 a0 05 00 00       	call   801c47 <pageref>
		nn = thisenv->env_runs;
  ...
  8016c1:	50                   	push   %eax
  8016c2:	53                   	push   %ebx
  8016c3:	68 12 23 80 00       	push   $0x802312
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801978:	68 2a 23 80 00       	push   $0x80232a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b19:	56                   	push   %esi
  801b1a:	50                   	push   %eax
  801b1b:	68 38 23 80 00       	push   $0x802338
  ...
  801b2c:	e8 d1 e5 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  801b31:	c7 04 24 1c 1f 80 00 	movl   $0x801f1c,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b57:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801b5c:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801b5f:	83 ec 0c             	sub    $0xc,%esp
  801b62:	50                   	push   %eax
  801b63:	e8 07 f2 ff ff       	call   800d6f <sys_ipc_recv>
  801b68:	83 c4 10             	add    $0x10,%esp
  801b6b:	85 c0                	test   %eax,%eax
  801b6d:	78 2b                	js     801b9a <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801b71:	74 0a                	je     801b7d <ipc_recv+0x3a>
  ...
  801b7f:	74 0a                	je     801b8b <ipc_recv+0x48>
  ...
  801b9c:	74 06                	je     801ba4 <ipc_recv+0x61>
			*from_env_store=0;
  801b9e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801ba4:	85 db                	test   %ebx,%ebx
  801ba6:	74 eb                	je     801b93 <ipc_recv+0x50>
			*perm_store=0;
  801ba8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801bae:	eb e3                	jmp    801b93 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bd4:	56                   	push   %esi
  801bd5:	57                   	push   %edi
  801bd6:	e8 6d f1 ff ff       	call   800d48 <sys_ipc_try_send>
		if(!res)
  801bdb:	83 c4 10             	add    $0x10,%esp
  801bde:	85 c0                	test   %eax,%eax
  801be0:	74 20                	je     801c02 <ipc_send+0x52>
			return;
  ...
  801be5:	75 07                	jne    801bee <ipc_send+0x3e>
		...
		sys_yield();
  801be7:	e8 94 ef ff ff       	call   800b80 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bec:	eb e2                	jmp    801bd0 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bee:	83 ec 04             	sub    $0x4,%esp
  801bf1:	68 5b 23 80 00       	push   $0x80235b
  801bf6:	6a 3f                	push   $0x3f
  801bf8:	68 73 23 80 00       	push   $0x802373
  801bfd:	e8 f7 fe ff ff       	call   801af9 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c19:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c1c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c22:	8b 52 50             	mov    0x50(%edx),%edx
  801c25:	39 ca                	cmp    %ecx,%edx
  801c27:	74 11                	je     801c3a <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c29:	83 c0 01             	add    $0x1,%eax
  801c2c:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c31:	75 e6                	jne    801c19 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c33:	b8 00 00 00 00       	mov    $0x0,%eax
  801c38:	eb 0b                	jmp    801c45 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801c3a:	6b c0 7c             	imul   $0x7c,%eax,%eax
...
pageref(void *v)
{
  ...
  801c53:	c1 ea 16             	shr    $0x16,%edx
  801c56:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801c5d:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801c62:	f6 c1 01             	test   $0x1,%cl
  801c65:	74 1c                	je     801c83 <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801c67:	c1 e8 0c             	shr    $0xc,%eax
  801c6a:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801c71:	a8 01                	test   $0x1,%al
  801c73:	74 0e                	je     801c83 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801c75:	c1 e8 0c             	shr    $0xc,%eax
  801c78:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801c7f:	ef 
  801c80:	0f b7 d2             	movzwl %dx,%edx
}
