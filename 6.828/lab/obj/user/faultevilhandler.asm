...
sys_env_destroy(envid_t envid)
{
  ...
  80014a:	68 0a 1f 80 00       	push   $0x801f0a
  80014f:	6a 23                	push   $0x23
  800151:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001d7:	68 0a 1f 80 00       	push   $0x801f0a
  8001dc:	6a 23                	push   $0x23
  8001de:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80021d:	68 0a 1f 80 00       	push   $0x801f0a
  800222:	6a 23                	push   $0x23
  800224:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800263:	68 0a 1f 80 00       	push   $0x801f0a
  800268:	6a 23                	push   $0x23
  80026a:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002a9:	68 0a 1f 80 00       	push   $0x801f0a
  8002ae:	6a 23                	push   $0x23
  8002b0:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002ef:	68 0a 1f 80 00       	push   $0x801f0a
  8002f4:	6a 23                	push   $0x23
  8002f6:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800335:	68 0a 1f 80 00       	push   $0x801f0a
  80033a:	6a 23                	push   $0x23
  80033c:	68 27 1f 80 00       	push   $0x801f27
...
sys_ipc_recv(void *dstva)
{
  ...
  8003a1:	68 0a 1f 80 00       	push   $0x801f0a
  8003a6:	6a 23                	push   $0x23
  8003a8:	68 27 1f 80 00       	push   $0x801f27
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800498:	ba b4 1f 80 00       	mov    $0x801fb4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8004ba:	51                   	push   %ecx
  8004bb:	50                   	push   %eax
  8004bc:	68 38 1f 80 00       	push   $0x801f38
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800728:	53                   	push   %ebx
  800729:	50                   	push   %eax
  80072a:	68 79 1f 80 00       	push   $0x801f79
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007f9:	53                   	push   %ebx
  8007fa:	50                   	push   %eax
  8007fb:	68 95 1f 80 00       	push   $0x801f95
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8008a9:	53                   	push   %ebx
  8008aa:	50                   	push   %eax
  8008ab:	68 58 1f 80 00       	push   $0x801f58
...
fsipc(unsigned type, void *dstva)
{
  ...
  8009a1:	e8 21 12 00 00       	call   801bc7 <ipc_send>
  ...
  8009bf:	e8 5d 12 00 00       	call   801c21 <ipc_find_env>
...
00800a7f <devfile_write>:
{
  ...
  800a8c:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  800a91:	ba f8 0f 00 00       	mov    $0xff8,%edx
  800a96:	0f 47 c2             	cmova  %edx,%eax
...
00800ac9 <devfile_read>:
{
  ...
  800b22:	c3                   	ret    
	assert(r <= n);
  800b23:	68 c4 1f 80 00       	push   $0x801fc4
  800b28:	68 cb 1f 80 00       	push   $0x801fcb
  800b2d:	6a 7d                	push   $0x7d
  800b2f:	68 e0 1f 80 00       	push   $0x801fe0
  800b34:	e8 be 05 00 00       	call   8010f7 <_panic>
	assert(r <= PGSIZE);
  800b39:	68 eb 1f 80 00       	push   $0x801feb
  800b3e:	68 cb 1f 80 00       	push   $0x801fcb
  800b43:	6a 7e                	push   $0x7e
  800b45:	68 e0 1f 80 00       	push   $0x801fe0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800c18:	68 f7 1f 80 00       	push   $0x801ff7
  800c1d:	53                   	push   %ebx
...
00800c7c <_pipeisclosed>:
{
  ...
  800c94:	57                   	push   %edi
  800c95:	e8 c4 0f 00 00       	call   801c5e <pageref>
  800c9a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800c9d:	89 34 24             	mov    %esi,(%esp)
  800ca0:	e8 b9 0f 00 00       	call   801c5e <pageref>
		nn = thisenv->env_runs;
  ...
  800cbf:	50                   	push   %eax
  800cc0:	53                   	push   %ebx
  800cc1:	68 fe 1f 80 00       	push   $0x801ffe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f76:	68 16 20 80 00       	push   $0x802016
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801117:	56                   	push   %esi
  801118:	50                   	push   %eax
  801119:	68 24 20 80 00       	push   $0x802024
  ...
  80112a:	e8 5a 00 00 00       	call   801189 <vcprintf>
	cprintf("\n");
  80112f:	c7 04 24 0f 20 80 00 	movl   $0x80200f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801244:	e8 57 0a 00 00       	call   801ca0 <__udivdi3>
  ...
  801282:	e8 29 0b 00 00       	call   801db0 <__umoddi3>
  801287:	83 c4 14             	add    $0x14,%esp
  80128a:	0f be 80 47 20 80 00 	movsbl 0x802047(%eax),%eax
  801291:	50                   	push   %eax
...
008012e1 <vprintfmt>:
{
  ...
  801331:	3e ff 24 85 80 21 80 	notrack jmp *0x802180(,%eax,4)
  801338:	00 
  ...
  8013fe:	8b 14 85 e0 22 80 00 	mov    0x8022e0(,%eax,4),%edx
  801405:	85 d2                	test   %edx,%edx
  801407:	74 18                	je     801421 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  801409:	52                   	push   %edx
  80140a:	68 dd 1f 80 00       	push   $0x801fdd
  80140f:	53                   	push   %ebx
  801410:	56                   	push   %esi
  ...
  801421:	50                   	push   %eax
  801422:	68 5f 20 80 00       	push   $0x80205f
  801427:	53                   	push   %ebx
  801428:	56                   	push   %esi
  ...
  801449:	b8 58 20 80 00       	mov    $0x802058,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b6e:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801b73:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801b76:	83 ec 0c             	sub    $0xc,%esp
  801b79:	50                   	push   %eax
  801b7a:	e8 ee e7 ff ff       	call   80036d <sys_ipc_recv>
  801b7f:	83 c4 10             	add    $0x10,%esp
  801b82:	85 c0                	test   %eax,%eax
  801b84:	78 2b                	js     801bb1 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801b88:	74 0a                	je     801b94 <ipc_recv+0x3a>
  ...
  801b96:	74 0a                	je     801ba2 <ipc_recv+0x48>
  ...
  801bb3:	74 06                	je     801bbb <ipc_recv+0x61>
			*from_env_store=0;
  801bb5:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801bbb:	85 db                	test   %ebx,%ebx
  801bbd:	74 eb                	je     801baa <ipc_recv+0x50>
			*perm_store=0;
  801bbf:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801bc5:	eb e3                	jmp    801baa <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bd4:	8b 7d 08             	mov    0x8(%ebp),%edi
  801bd7:	8b 75 0c             	mov    0xc(%ebp),%esi
  801bda:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 4: Your code here.
	if(!pg)
		pg=(void *)UTOP;
  801bdd:	85 db                	test   %ebx,%ebx
  801bdf:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801be4:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
  ...
  801beb:	56                   	push   %esi
  801bec:	57                   	push   %edi
  801bed:	e8 54 e7 ff ff       	call   800346 <sys_ipc_try_send>
		if(!res)
  801bf2:	83 c4 10             	add    $0x10,%esp
  801bf5:	85 c0                	test   %eax,%eax
  801bf7:	74 20                	je     801c19 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bf9:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bfc:	75 07                	jne    801c05 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801bfe:	e8 7b e5 ff ff       	call   80017e <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801c03:	eb e2                	jmp    801be7 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801c05:	83 ec 04             	sub    $0x4,%esp
  801c08:	68 3f 23 80 00       	push   $0x80233f
  801c0d:	6a 3f                	push   $0x3f
  801c0f:	68 57 23 80 00       	push   $0x802357
  801c14:	e8 de f4 ff ff       	call   8010f7 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c3e:	74 11                	je     801c51 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c40:	83 c0 01             	add    $0x1,%eax
  801c43:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c48:	75 e6                	jne    801c30 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c4a:	b8 00 00 00 00       	mov    $0x0,%eax
  801c4f:	eb 0b                	jmp    801c5c <ipc_find_env+0x3b>
			return envs[i].env_id;
