	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001de:	e8 cd 1a 00 00       	call   801cb0 <__udivdi3>
  ...
  80021c:	e8 9f 1b 00 00       	call   801dc0 <__umoddi3>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013c4:	e8 08 08 00 00       	call   801bd1 <ipc_send>
  ...
  8013e2:	e8 44 08 00 00       	call   801c2b <ipc_find_env>
...
0080169f <_pipeisclosed>:
{
  ...
  8016b7:	57                   	push   %edi
  8016b8:	e8 ab 05 00 00       	call   801c68 <pageref>
  8016bd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8016c0:	89 34 24             	mov    %esi,(%esp)
  8016c3:	e8 a0 05 00 00       	call   801c68 <pageref>
		nn = thisenv->env_runs;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b4d:	e8 d1 e5 ff ff       	call   800123 <vcprintf>
	cprintf("\n");
  801b52:	c7 04 24 63 23 80 00 	movl   $0x802363,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b83:	50                   	push   %eax
  801b84:	e8 07 f2 ff ff       	call   800d90 <sys_ipc_recv>
  801b89:	83 c4 10             	add    $0x10,%esp
  801b8c:	85 c0                	test   %eax,%eax
  801b8e:	78 2b                	js     801bbb <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801b92:	74 0a                	je     801b9e <ipc_recv+0x3a>
  ...
  801ba0:	74 0a                	je     801bac <ipc_recv+0x48>
  ...
  801bbd:	74 06                	je     801bc5 <ipc_recv+0x61>
			*from_env_store=0;
  801bbf:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801bc5:	85 db                	test   %ebx,%ebx
  801bc7:	74 eb                	je     801bb4 <ipc_recv+0x50>
			*perm_store=0;
  801bc9:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801bcf:	eb e3                	jmp    801bb4 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bf5:	56                   	push   %esi
  801bf6:	57                   	push   %edi
  801bf7:	e8 6d f1 ff ff       	call   800d69 <sys_ipc_try_send>
		if(!res)
  801bfc:	83 c4 10             	add    $0x10,%esp
  801bff:	85 c0                	test   %eax,%eax
  801c01:	74 20                	je     801c23 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801c03:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c06:	75 07                	jne    801c0f <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801c08:	e8 94 ef ff ff       	call   800ba1 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801c0d:	eb e2                	jmp    801bf1 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801c0f:	83 ec 04             	sub    $0x4,%esp
  801c12:	68 9b 23 80 00       	push   $0x80239b
  801c17:	6a 3f                	push   $0x3f
  801c19:	68 b3 23 80 00       	push   $0x8023b3
  801c1e:	e8 f7 fe ff ff       	call   801b1a <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c3a:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c3d:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c43:	8b 52 50             	mov    0x50(%edx),%edx
  801c46:	39 ca                	cmp    %ecx,%edx
  801c48:	74 11                	je     801c5b <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c4a:	83 c0 01             	add    $0x1,%eax
  801c4d:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c52:	75 e6                	jne    801c3a <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c54:	b8 00 00 00 00       	mov    $0x0,%eax
  801c59:	eb 0b                	jmp    801c66 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801c5b:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801c5e:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
pageref(void *v)
{
  ...
  801c77:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801c7e:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801c83:	f6 c1 01             	test   $0x1,%cl
  801c86:	74 1c                	je     801ca4 <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801c88:	c1 e8 0c             	shr    $0xc,%eax
  801c8b:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801c92:	a8 01                	test   $0x1,%al
  801c94:	74 0e                	je     801ca4 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801c96:	c1 e8 0c             	shr    $0xc,%eax
  801c99:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801ca0:	ef 
  801ca1:	0f b7 d2             	movzwl %dx,%edx
}
