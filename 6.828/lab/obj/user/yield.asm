	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800209:	e8 d2 1a 00 00       	call   801ce0 <__udivdi3>
  ...
  800247:	e8 a4 1b 00 00       	call   801df0 <__umoddi3>
  80024c:	83 c4 14             	add    $0x14,%esp
  80024f:	0f be 80 b5 1f 80 00 	movsbl 0x801fb5(%eax),%eax
  800256:	50                   	push   %eax
...
008002a6 <vprintfmt>:
{
  ...
  8002f6:	3e ff 24 85 00 21 80 	notrack jmp *0x802100(,%eax,4)
  8002fd:	00 
  ...
  8003c3:	8b 14 85 60 22 80 00 	mov    0x802260(,%eax,4),%edx
  8003ca:	85 d2                	test   %edx,%edx
  8003cc:	74 18                	je     8003e6 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8003ce:	52                   	push   %edx
  8003cf:	68 91 23 80 00       	push   $0x802391
  8003d4:	53                   	push   %ebx
  8003d5:	56                   	push   %esi
  ...
  8003e6:	50                   	push   %eax
  8003e7:	68 cd 1f 80 00       	push   $0x801fcd
  8003ec:	53                   	push   %ebx
  8003ed:	56                   	push   %esi
  ...
  80040e:	b8 c6 1f 80 00       	mov    $0x801fc6,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b98:	68 bf 22 80 00       	push   $0x8022bf
  800b9d:	6a 23                	push   $0x23
  800b9f:	68 dc 22 80 00       	push   $0x8022dc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c25:	68 bf 22 80 00       	push   $0x8022bf
  800c2a:	6a 23                	push   $0x23
  800c2c:	68 dc 22 80 00       	push   $0x8022dc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c6b:	68 bf 22 80 00       	push   $0x8022bf
  800c70:	6a 23                	push   $0x23
  800c72:	68 dc 22 80 00       	push   $0x8022dc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb1:	68 bf 22 80 00       	push   $0x8022bf
  800cb6:	6a 23                	push   $0x23
  800cb8:	68 dc 22 80 00       	push   $0x8022dc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cf7:	68 bf 22 80 00       	push   $0x8022bf
  800cfc:	6a 23                	push   $0x23
  800cfe:	68 dc 22 80 00       	push   $0x8022dc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d3d:	68 bf 22 80 00       	push   $0x8022bf
  800d42:	6a 23                	push   $0x23
  800d44:	68 dc 22 80 00       	push   $0x8022dc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d83:	68 bf 22 80 00       	push   $0x8022bf
  800d88:	6a 23                	push   $0x23
  800d8a:	68 dc 22 80 00       	push   $0x8022dc
...
sys_ipc_recv(void *dstva)
{
  ...
  800def:	68 bf 22 80 00       	push   $0x8022bf
  800df4:	6a 23                	push   $0x23
  800df6:	68 dc 22 80 00       	push   $0x8022dc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ee6:	ba 68 23 80 00       	mov    $0x802368,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800f08:	51                   	push   %ecx
  800f09:	50                   	push   %eax
  800f0a:	68 ec 22 80 00       	push   $0x8022ec
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801176:	53                   	push   %ebx
  801177:	50                   	push   %eax
  801178:	68 2d 23 80 00       	push   $0x80232d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801247:	53                   	push   %ebx
  801248:	50                   	push   %eax
  801249:	68 49 23 80 00       	push   $0x802349
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012f7:	53                   	push   %ebx
  8012f8:	50                   	push   %eax
  8012f9:	68 0c 23 80 00       	push   $0x80230c
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013ef:	e8 08 08 00 00       	call   801bfc <ipc_send>
  ...
  80140d:	e8 44 08 00 00       	call   801c56 <ipc_find_env>
...
008014cd <devfile_write>:
{
  ...
  8014da:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8014df:	ba f8 0f 00 00       	mov    $0xff8,%edx
  8014e4:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  8014e7:	8b 55 08             	mov    0x8(%ebp),%edx
  8014ea:	8b 52 0c             	mov    0xc(%edx),%edx
  8014ed:	89 15 00 50 80 00    	mov    %edx,0x805000
...
00801517 <devfile_read>:
{
  ...
  801576:	68 7f 23 80 00       	push   $0x80237f
  80157b:	6a 7d                	push   $0x7d
  80157d:	68 94 23 80 00       	push   $0x802394
  801582:	e8 be 05 00 00       	call   801b45 <_panic>
	assert(r <= PGSIZE);
  801587:	68 9f 23 80 00       	push   $0x80239f
  80158c:	68 7f 23 80 00       	push   $0x80237f
  801591:	6a 7e                	push   $0x7e
  801593:	68 94 23 80 00       	push   $0x802394
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801666:	68 ab 23 80 00       	push   $0x8023ab
  80166b:	53                   	push   %ebx
...
008016ca <_pipeisclosed>:
{
  ...
  8016e2:	57                   	push   %edi
  8016e3:	e8 ab 05 00 00       	call   801c93 <pageref>
  8016e8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8016eb:	89 34 24             	mov    %esi,(%esp)
  8016ee:	e8 a0 05 00 00       	call   801c93 <pageref>
		nn = thisenv->env_runs;
  ...
  80170d:	50                   	push   %eax
  80170e:	53                   	push   %ebx
  80170f:	68 b2 23 80 00       	push   $0x8023b2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8019c4:	68 ca 23 80 00       	push   $0x8023ca
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b65:	56                   	push   %esi
  801b66:	50                   	push   %eax
  801b67:	68 d8 23 80 00       	push   $0x8023d8
  ...
  801b78:	e8 d1 e5 ff ff       	call   80014e <vcprintf>
	cprintf("\n");
  801b7d:	c7 04 24 c3 23 80 00 	movl   $0x8023c3,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ba3:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801ba8:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801bab:	83 ec 0c             	sub    $0xc,%esp
  801bae:	50                   	push   %eax
  801baf:	e8 07 f2 ff ff       	call   800dbb <sys_ipc_recv>
  801bb4:	83 c4 10             	add    $0x10,%esp
  801bb7:	85 c0                	test   %eax,%eax
  801bb9:	78 2b                	js     801be6 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801bbd:	74 0a                	je     801bc9 <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  801bbf:	a1 04 40 80 00       	mov    0x804004,%eax
  801bc4:	8b 40 74             	mov    0x74(%eax),%eax
  801bc7:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801bc9:	85 db                	test   %ebx,%ebx
  801bcb:	74 0a                	je     801bd7 <ipc_recv+0x48>
		*perm_store=thisenv->env_ipc_perm;
  801bcd:	a1 04 40 80 00       	mov    0x804004,%eax
  801bd2:	8b 40 78             	mov    0x78(%eax),%eax
  801bd5:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  801bd7:	a1 04 40 80 00       	mov    0x804004,%eax
  801bdc:	8b 40 70             	mov    0x70(%eax),%eax
}
  ...
  801be8:	74 06                	je     801bf0 <ipc_recv+0x61>
			*from_env_store=0;
  801bea:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801bf0:	85 db                	test   %ebx,%ebx
  801bf2:	74 eb                	je     801bdf <ipc_recv+0x50>
			*perm_store=0;
  801bf4:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801bfa:	eb e3                	jmp    801bdf <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c14:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801c19:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
  ...
  801c20:	56                   	push   %esi
  801c21:	57                   	push   %edi
  801c22:	e8 6d f1 ff ff       	call   800d94 <sys_ipc_try_send>
		if(!res)
  801c27:	83 c4 10             	add    $0x10,%esp
  801c2a:	85 c0                	test   %eax,%eax
  801c2c:	74 20                	je     801c4e <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801c2e:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c31:	75 07                	jne    801c3a <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801c33:	e8 94 ef ff ff       	call   800bcc <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801c38:	eb e2                	jmp    801c1c <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801c3a:	83 ec 04             	sub    $0x4,%esp
  801c3d:	68 fb 23 80 00       	push   $0x8023fb
  801c42:	6a 3f                	push   $0x3f
  801c44:	68 13 24 80 00       	push   $0x802413
  801c49:	e8 f7 fe ff ff       	call   801b45 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c65:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c68:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c6e:	8b 52 50             	mov    0x50(%edx),%edx
  801c71:	39 ca                	cmp    %ecx,%edx
  801c73:	74 11                	je     801c86 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c75:	83 c0 01             	add    $0x1,%eax
  801c78:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c7d:	75 e6                	jne    801c65 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c7f:	b8 00 00 00 00       	mov    $0x0,%eax
  801c84:	eb 0b                	jmp    801c91 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801c86:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801c89:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801c8e:	8b 40 48             	mov    0x48(%eax),%eax
}
  801c91:	5d                   	pop    %ebp
  801c92:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801c9f:	c1 ea 16             	shr    $0x16,%edx
  801ca2:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801ca9:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801cae:	f6 c1 01             	test   $0x1,%cl
  801cb1:	74 1c                	je     801ccf <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801cb3:	c1 e8 0c             	shr    $0xc,%eax
  801cb6:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801cbd:	a8 01                	test   $0x1,%al
  801cbf:	74 0e                	je     801ccf <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801cc1:	c1 e8 0c             	shr    $0xc,%eax
  801cc4:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801ccb:	ef 
  801ccc:	0f b7 d2             	movzwl %dx,%edx
}
