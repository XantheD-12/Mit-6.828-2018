...
ls1(const char *prefix, bool isdir, off_t size, const char *name)
{
  ...
  80005e:	68 02 24 80 00       	push   $0x802402
  ...
  80006d:	74 1c                	je     80008b <ls1+0x58>
		if (prefix[0] && prefix[strlen(prefix)-1] != '/')
			...
			sep = "";
  80006f:	b8 68 24 80 00       	mov    $0x802468,%eax
		if (prefix[0] && prefix[strlen(prefix)-1] != '/')
  ...
  80007c:	50                   	push   %eax
  80007d:	53                   	push   %ebx
  80007e:	68 0b 24 80 00       	push   $0x80240b
  ...
  800091:	68 91 28 80 00       	push   $0x802891
  ...
  8000b0:	68 67 24 80 00       	push   $0x802467
  ...
  8000d5:	b8 00 24 80 00       	mov    $0x802400,%eax
  8000da:	ba 68 24 80 00       	mov    $0x802468,%edx
  8000df:	0f 44 c2             	cmove  %edx,%eax
  8000e2:	eb 95                	jmp    800079 <ls1+0x46>
		printf("/");
  8000e4:	83 ec 0c             	sub    $0xc,%esp
  8000e7:	68 00 24 80 00       	push   $0x802400
...
008000f6 <lsdir>:
{
  ...
  800167:	50                   	push   %eax
  800168:	57                   	push   %edi
  800169:	68 10 24 80 00       	push   $0x802410
  80016e:	6a 1d                	push   $0x1d
  800170:	68 1c 24 80 00       	push   $0x80241c
  ...
  800188:	57                   	push   %edi
  800189:	68 26 24 80 00       	push   $0x802426
  80018e:	6a 22                	push   $0x22
  800190:	68 1c 24 80 00       	push   $0x80241c
  800195:	e8 a8 01 00 00       	call   800342 <_panic>
		panic("error reading directory %s: %e", path, n);
  80019a:	83 ec 0c             	sub    $0xc,%esp
  80019d:	50                   	push   %eax
  80019e:	57                   	push   %edi
  80019f:	68 6c 24 80 00       	push   $0x80246c
  8001a4:	6a 24                	push   $0x24
  8001a6:	68 1c 24 80 00       	push   $0x80241c
...
008001b0 <ls>:
{
  ...
  800204:	50                   	push   %eax
  800205:	53                   	push   %ebx
  800206:	68 41 24 80 00       	push   $0x802441
  80020b:	6a 0f                	push   $0xf
  80020d:	68 1c 24 80 00       	push   $0x80241c
...
usage(void)
{
  ...
  800232:	68 4d 24 80 00       	push   $0x80244d
...
umain(int argc, char **argv)
{
  ...
  8002a7:	68 68 24 80 00       	push   $0x802468
  8002ac:	68 00 24 80 00       	push   $0x802400
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800362:	56                   	push   %esi
  800363:	50                   	push   %eax
  800364:	68 98 24 80 00       	push   $0x802498
  ...
  800375:	e8 5a 00 00 00       	call   8003d4 <vcprintf>
	cprintf("\n");
  80037a:	c7 04 24 67 24 80 00 	movl   $0x802467,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80048f:	e8 0c 1d 00 00       	call   8021a0 <__udivdi3>
  ...
  8004cd:	e8 de 1d 00 00       	call   8022b0 <__umoddi3>
  8004d2:	83 c4 14             	add    $0x14,%esp
  8004d5:	0f be 80 bb 24 80 00 	movsbl 0x8024bb(%eax),%eax
  8004dc:	50                   	push   %eax
...
0080052c <vprintfmt>:
{
  ...
  80057c:	3e ff 24 85 00 26 80 	notrack jmp *0x802600(,%eax,4)
  800583:	00 
  ...
  800649:	8b 14 85 60 27 80 00 	mov    0x802760(,%eax,4),%edx
  800650:	85 d2                	test   %edx,%edx
  800652:	74 18                	je     80066c <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800654:	52                   	push   %edx
  800655:	68 91 28 80 00       	push   $0x802891
  80065a:	53                   	push   %ebx
  80065b:	56                   	push   %esi
  ...
  80066c:	50                   	push   %eax
  80066d:	68 d3 24 80 00       	push   $0x8024d3
  800672:	53                   	push   %ebx
  800673:	56                   	push   %esi
  ...
  800694:	b8 cc 24 80 00       	mov    $0x8024cc,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800eab:	68 bf 27 80 00       	push   $0x8027bf
  800eb0:	6a 23                	push   $0x23
  800eb2:	68 dc 27 80 00       	push   $0x8027dc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ef1:	68 bf 27 80 00       	push   $0x8027bf
  800ef6:	6a 23                	push   $0x23
  800ef8:	68 dc 27 80 00       	push   $0x8027dc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800f37:	68 bf 27 80 00       	push   $0x8027bf
  800f3c:	6a 23                	push   $0x23
  800f3e:	68 dc 27 80 00       	push   $0x8027dc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f7d:	68 bf 27 80 00       	push   $0x8027bf
  800f82:	6a 23                	push   $0x23
  800f84:	68 dc 27 80 00       	push   $0x8027dc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800fc3:	68 bf 27 80 00       	push   $0x8027bf
  800fc8:	6a 23                	push   $0x23
  800fca:	68 dc 27 80 00       	push   $0x8027dc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801009:	68 bf 27 80 00       	push   $0x8027bf
  80100e:	6a 23                	push   $0x23
  801010:	68 dc 27 80 00       	push   $0x8027dc
...
sys_ipc_recv(void *dstva)
{
  ...
  801075:	68 bf 27 80 00       	push   $0x8027bf
  80107a:	6a 23                	push   $0x23
  80107c:	68 dc 27 80 00       	push   $0x8027dc
...
argstart(int *argc, char **argv, struct Argstate *args)
{
  ...
  8010a0:	ba 68 24 80 00       	mov    $0x802468,%edx
...
argnextvalue(struct Argstate *args)
{
  ...
  80116b:	89 43 0c             	mov    %eax,0xc(%ebx)
		args->curarg = "";
  80116e:	c7 43 08 68 24 80 00 	movl   $0x802468,0x8(%ebx)
		(*args->argc)--;
	} else {
		args->argvalue = 0;
		args->curarg = 0;
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8012cb:	ba 68 28 80 00       	mov    $0x802868,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8012ed:	51                   	push   %ecx
  8012ee:	50                   	push   %eax
  8012ef:	68 ec 27 80 00       	push   $0x8027ec
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80155b:	53                   	push   %ebx
  80155c:	50                   	push   %eax
  80155d:	68 2d 28 80 00       	push   $0x80282d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80162c:	53                   	push   %ebx
  80162d:	50                   	push   %eax
  80162e:	68 49 28 80 00       	push   $0x802849
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8016dc:	53                   	push   %ebx
  8016dd:	50                   	push   %eax
  8016de:	68 0c 28 80 00       	push   $0x80280c
...
fsipc(unsigned type, void *dstva)
{
  ...
  8017d4:	e8 e2 08 00 00       	call   8020bb <ipc_send>
  ...
  8017f2:	e8 1e 09 00 00       	call   802115 <ipc_find_env>
...
008018b2 <devfile_write>:
{
  ...
  8018bf:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8018c4:	ba f8 0f 00 00       	mov    $0xff8,%edx
  8018c9:	0f 47 c2             	cmova  %edx,%eax
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b6f:	68 ab 28 80 00       	push   $0x8028ab
  801b74:	53                   	push   %ebx
...
00801bd3 <_pipeisclosed>:
{
  ...
  801beb:	57                   	push   %edi
  801bec:	e8 61 05 00 00       	call   802152 <pageref>
  801bf1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801bf4:	89 34 24             	mov    %esi,(%esp)
  801bf7:	e8 56 05 00 00       	call   802152 <pageref>
		nn = thisenv->env_runs;
  ...
  801c16:	50                   	push   %eax
  801c17:	53                   	push   %ebx
  801c18:	68 b2 28 80 00       	push   $0x8028b2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801ecd:	68 ca 28 80 00       	push   $0x8028ca
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  802062:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  802067:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  80206a:	83 ec 0c             	sub    $0xc,%esp
  80206d:	50                   	push   %eax
  80206e:	e8 ce ef ff ff       	call   801041 <sys_ipc_recv>
  802073:	83 c4 10             	add    $0x10,%esp
  802076:	85 c0                	test   %eax,%eax
  802078:	78 2b                	js     8020a5 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  80207c:	74 0a                	je     802088 <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  80207e:	a1 20 44 80 00       	mov    0x804420,%eax
  802083:	8b 40 74             	mov    0x74(%eax),%eax
  802086:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  802088:	85 db                	test   %ebx,%ebx
  80208a:	74 0a                	je     802096 <ipc_recv+0x48>
		*perm_store=thisenv->env_ipc_perm;
  80208c:	a1 20 44 80 00       	mov    0x804420,%eax
  802091:	8b 40 78             	mov    0x78(%eax),%eax
  802094:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  802096:	a1 20 44 80 00       	mov    0x804420,%eax
  ...
  8020a4:	c3                   	ret    
		if(from_env_store)
  8020a5:	85 f6                	test   %esi,%esi
  8020a7:	74 06                	je     8020af <ipc_recv+0x61>
			*from_env_store=0;
  8020a9:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  8020af:	85 db                	test   %ebx,%ebx
  8020b1:	74 eb                	je     80209e <ipc_recv+0x50>
			*perm_store=0;
  8020b3:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8020b9:	eb e3                	jmp    80209e <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  8020df:	56                   	push   %esi
  8020e0:	57                   	push   %edi
  8020e1:	e8 34 ef ff ff       	call   80101a <sys_ipc_try_send>
		if(!res)
  8020e6:	83 c4 10             	add    $0x10,%esp
  8020e9:	85 c0                	test   %eax,%eax
  8020eb:	74 20                	je     80210d <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  8020ed:	83 f8 f9             	cmp    $0xfffffff9,%eax
  8020f0:	75 07                	jne    8020f9 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  8020f2:	e8 5b ed ff ff       	call   800e52 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  8020f7:	eb e2                	jmp    8020db <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  8020f9:	83 ec 04             	sub    $0x4,%esp
  8020fc:	68 d6 28 80 00       	push   $0x8028d6
  802101:	6a 3f                	push   $0x3f
  802103:	68 ee 28 80 00       	push   $0x8028ee
  802108:	e8 35 e2 ff ff       	call   800342 <_panic>
	}
}
