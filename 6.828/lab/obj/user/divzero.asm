	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001cf:	e8 cc 1a 00 00       	call   801ca0 <__udivdi3>
  ...
  80020d:	e8 9e 1b 00 00       	call   801db0 <__umoddi3>
  800212:	83 c4 14             	add    $0x14,%esp
  800215:	0f be 80 18 1f 80 00 	movsbl 0x801f18(%eax),%eax
  80021c:	50                   	push   %eax
...
0080026c <vprintfmt>:
{
  ...
  8002bc:	3e ff 24 85 60 20 80 	notrack jmp *0x802060(,%eax,4)
  8002c3:	00 
  ...
  800389:	8b 14 85 c0 21 80 00 	mov    0x8021c0(,%eax,4),%edx
  800390:	85 d2                	test   %edx,%edx
  800392:	74 18                	je     8003ac <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800394:	52                   	push   %edx
  800395:	68 f1 22 80 00       	push   $0x8022f1
  80039a:	53                   	push   %ebx
  80039b:	56                   	push   %esi
  ...
  8003ac:	50                   	push   %eax
  8003ad:	68 30 1f 80 00       	push   $0x801f30
  8003b2:	53                   	push   %ebx
  8003b3:	56                   	push   %esi
  ...
  8003d4:	b8 29 1f 80 00       	mov    $0x801f29,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b5e:	68 1f 22 80 00       	push   $0x80221f
  800b63:	6a 23                	push   $0x23
  800b65:	68 3c 22 80 00       	push   $0x80223c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800beb:	68 1f 22 80 00       	push   $0x80221f
  800bf0:	6a 23                	push   $0x23
  800bf2:	68 3c 22 80 00       	push   $0x80223c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c31:	68 1f 22 80 00       	push   $0x80221f
  800c36:	6a 23                	push   $0x23
  800c38:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d03:	68 1f 22 80 00       	push   $0x80221f
  800d08:	6a 23                	push   $0x23
  800d0a:	68 3c 22 80 00       	push   $0x80223c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d49:	68 1f 22 80 00       	push   $0x80221f
  800d4e:	6a 23                	push   $0x23
  800d50:	68 3c 22 80 00       	push   $0x80223c
...
sys_ipc_recv(void *dstva)
{
  ...
  800db5:	68 1f 22 80 00       	push   $0x80221f
  800dba:	6a 23                	push   $0x23
  800dbc:	68 3c 22 80 00       	push   $0x80223c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800eac:	ba c8 22 80 00       	mov    $0x8022c8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800ece:	51                   	push   %ecx
  800ecf:	50                   	push   %eax
  800ed0:	68 4c 22 80 00       	push   $0x80224c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80113c:	53                   	push   %ebx
  80113d:	50                   	push   %eax
  80113e:	68 8d 22 80 00       	push   $0x80228d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80120d:	53                   	push   %ebx
  80120e:	50                   	push   %eax
  80120f:	68 a9 22 80 00       	push   $0x8022a9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012bd:	53                   	push   %ebx
  8012be:	50                   	push   %eax
  8012bf:	68 6c 22 80 00       	push   $0x80226c
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013b5:	e8 08 08 00 00       	call   801bc2 <ipc_send>
  ...
  8013d3:	e8 44 08 00 00       	call   801c1c <ipc_find_env>
...
00801493 <devfile_write>:
{
  ...
  8014a0:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8014a5:	ba f8 0f 00 00       	mov    $0xff8,%edx
  8014aa:	0f 47 c2             	cmova  %edx,%eax
...
008014dd <devfile_read>:
{
  ...
  801536:	c3                   	ret    
	assert(r <= n);
  801537:	68 d8 22 80 00       	push   $0x8022d8
  80153c:	68 df 22 80 00       	push   $0x8022df
  801541:	6a 7d                	push   $0x7d
  801543:	68 f4 22 80 00       	push   $0x8022f4
  801548:	e8 be 05 00 00       	call   801b0b <_panic>
	assert(r <= PGSIZE);
  80154d:	68 ff 22 80 00       	push   $0x8022ff
  801552:	68 df 22 80 00       	push   $0x8022df
  801557:	6a 7e                	push   $0x7e
  801559:	68 f4 22 80 00       	push   $0x8022f4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80162c:	68 0b 23 80 00       	push   $0x80230b
  801631:	53                   	push   %ebx
...
00801690 <_pipeisclosed>:
{
  ...
  8016a8:	57                   	push   %edi
  8016a9:	e8 ab 05 00 00       	call   801c59 <pageref>
  8016ae:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8016b1:	89 34 24             	mov    %esi,(%esp)
  8016b4:	e8 a0 05 00 00       	call   801c59 <pageref>
		nn = thisenv->env_runs;
  ...
  8016d3:	50                   	push   %eax
  8016d4:	53                   	push   %ebx
  8016d5:	68 12 23 80 00       	push   $0x802312
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80198a:	68 2a 23 80 00       	push   $0x80232a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b2b:	56                   	push   %esi
  801b2c:	50                   	push   %eax
  801b2d:	68 38 23 80 00       	push   $0x802338
  ...
  801b3e:	e8 d1 e5 ff ff       	call   800114 <vcprintf>
	cprintf("\n");
  801b43:	c7 04 24 0c 1f 80 00 	movl   $0x801f0c,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b69:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801b6e:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801b71:	83 ec 0c             	sub    $0xc,%esp
  801b74:	50                   	push   %eax
  801b75:	e8 07 f2 ff ff       	call   800d81 <sys_ipc_recv>
  801b7a:	83 c4 10             	add    $0x10,%esp
  801b7d:	85 c0                	test   %eax,%eax
  801b7f:	78 2b                	js     801bac <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801b83:	74 0a                	je     801b8f <ipc_recv+0x3a>
  ...
  801b91:	74 0a                	je     801b9d <ipc_recv+0x48>
  ...
  801bab:	c3                   	ret    
		if(from_env_store)
  801bac:	85 f6                	test   %esi,%esi
  801bae:	74 06                	je     801bb6 <ipc_recv+0x61>
			*from_env_store=0;
  801bb0:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801bb6:	85 db                	test   %ebx,%ebx
  801bb8:	74 eb                	je     801ba5 <ipc_recv+0x50>
			*perm_store=0;
  801bba:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801bc0:	eb e3                	jmp    801ba5 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bda:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801bdf:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
  ...
  801be6:	56                   	push   %esi
  801be7:	57                   	push   %edi
  801be8:	e8 6d f1 ff ff       	call   800d5a <sys_ipc_try_send>
		if(!res)
  801bed:	83 c4 10             	add    $0x10,%esp
  801bf0:	85 c0                	test   %eax,%eax
  801bf2:	74 20                	je     801c14 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bf4:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bf7:	75 07                	jne    801c00 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801bf9:	e8 94 ef ff ff       	call   800b92 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bfe:	eb e2                	jmp    801be2 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801c00:	83 ec 04             	sub    $0x4,%esp
  801c03:	68 5b 23 80 00       	push   $0x80235b
  801c08:	6a 3f                	push   $0x3f
  801c0a:	68 73 23 80 00       	push   $0x802373
  801c0f:	e8 f7 fe ff ff       	call   801b0b <_panic>
	}
}
