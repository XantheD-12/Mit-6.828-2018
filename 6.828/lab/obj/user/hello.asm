	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001cd:	e8 ce 1a 00 00       	call   801ca0 <__udivdi3>
  ...
  80020b:	e8 a0 1b 00 00       	call   801db0 <__umoddi3>
  800210:	83 c4 14             	add    $0x14,%esp
  800213:	0f be 80 2f 1f 80 00 	movsbl 0x801f2f(%eax),%eax
  80021a:	50                   	push   %eax
...
0080026a <vprintfmt>:
{
  ...
  8002ba:	3e ff 24 85 80 20 80 	notrack jmp *0x802080(,%eax,4)
  8002c1:	00 
  ...
  800387:	8b 14 85 e0 21 80 00 	mov    0x8021e0(,%eax,4),%edx
  80038e:	85 d2                	test   %edx,%edx
  800390:	74 18                	je     8003aa <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800392:	52                   	push   %edx
  800393:	68 11 23 80 00       	push   $0x802311
  800398:	53                   	push   %ebx
  800399:	56                   	push   %esi
  ...
  8003aa:	50                   	push   %eax
  8003ab:	68 47 1f 80 00       	push   $0x801f47
  8003b0:	53                   	push   %ebx
  8003b1:	56                   	push   %esi
  ...
  8003d2:	b8 40 1f 80 00       	mov    $0x801f40,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b5c:	68 3f 22 80 00       	push   $0x80223f
  800b61:	6a 23                	push   $0x23
  800b63:	68 5c 22 80 00       	push   $0x80225c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800be9:	68 3f 22 80 00       	push   $0x80223f
  800bee:	6a 23                	push   $0x23
  800bf0:	68 5c 22 80 00       	push   $0x80225c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c2f:	68 3f 22 80 00       	push   $0x80223f
  800c34:	6a 23                	push   $0x23
  800c36:	68 5c 22 80 00       	push   $0x80225c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c75:	68 3f 22 80 00       	push   $0x80223f
  800c7a:	6a 23                	push   $0x23
  800c7c:	68 5c 22 80 00       	push   $0x80225c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cbb:	68 3f 22 80 00       	push   $0x80223f
  800cc0:	6a 23                	push   $0x23
  800cc2:	68 5c 22 80 00       	push   $0x80225c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d01:	68 3f 22 80 00       	push   $0x80223f
  800d06:	6a 23                	push   $0x23
  800d08:	68 5c 22 80 00       	push   $0x80225c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d47:	68 3f 22 80 00       	push   $0x80223f
  800d4c:	6a 23                	push   $0x23
  800d4e:	68 5c 22 80 00       	push   $0x80225c
...
sys_ipc_recv(void *dstva)
{
  ...
  800db3:	68 3f 22 80 00       	push   $0x80223f
  800db8:	6a 23                	push   $0x23
  800dba:	68 5c 22 80 00       	push   $0x80225c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800eaa:	ba e8 22 80 00       	mov    $0x8022e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800ecc:	51                   	push   %ecx
  800ecd:	50                   	push   %eax
  800ece:	68 6c 22 80 00       	push   $0x80226c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80113a:	53                   	push   %ebx
  80113b:	50                   	push   %eax
  80113c:	68 ad 22 80 00       	push   $0x8022ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80120b:	53                   	push   %ebx
  80120c:	50                   	push   %eax
  80120d:	68 c9 22 80 00       	push   $0x8022c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8012bb:	53                   	push   %ebx
  8012bc:	50                   	push   %eax
  8012bd:	68 8c 22 80 00       	push   $0x80228c
...
fsipc(unsigned type, void *dstva)
{
  ...
  8013b3:	e8 08 08 00 00       	call   801bc0 <ipc_send>
  ...
  8013d1:	e8 44 08 00 00       	call   801c1a <ipc_find_env>
...
00801491 <devfile_write>:
{
  ...
  8014a3:	ba f8 0f 00 00       	mov    $0xff8,%edx
  8014a8:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  8014ab:	8b 55 08             	mov    0x8(%ebp),%edx
  8014ae:	8b 52 0c             	mov    0xc(%edx),%edx
  8014b1:	89 15 00 50 80 00    	mov    %edx,0x805000
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80162a:	68 2b 23 80 00       	push   $0x80232b
  80162f:	53                   	push   %ebx
...
0080168e <_pipeisclosed>:
{
  ...
  8016a6:	57                   	push   %edi
  8016a7:	e8 ab 05 00 00       	call   801c57 <pageref>
  8016ac:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8016af:	89 34 24             	mov    %esi,(%esp)
  8016b2:	e8 a0 05 00 00       	call   801c57 <pageref>
		nn = thisenv->env_runs;
  ...
  8016d1:	50                   	push   %eax
  8016d2:	53                   	push   %ebx
  8016d3:	68 32 23 80 00       	push   $0x802332
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801988:	68 4a 23 80 00       	push   $0x80234a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b29:	56                   	push   %esi
  801b2a:	50                   	push   %eax
  801b2b:	68 58 23 80 00       	push   $0x802358
  ...
  801b3c:	e8 d1 e5 ff ff       	call   800112 <vcprintf>
	cprintf("\n");
  801b41:	c7 04 24 43 23 80 00 	movl   $0x802343,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b72:	50                   	push   %eax
  801b73:	e8 07 f2 ff ff       	call   800d7f <sys_ipc_recv>
  801b78:	83 c4 10             	add    $0x10,%esp
  801b7b:	85 c0                	test   %eax,%eax
  801b7d:	78 2b                	js     801baa <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801bac:	74 06                	je     801bb4 <ipc_recv+0x61>
			*from_env_store=0;
  801bae:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801bb4:	85 db                	test   %ebx,%ebx
  801bb6:	74 eb                	je     801ba3 <ipc_recv+0x50>
			*perm_store=0;
  801bb8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801bbe:	eb e3                	jmp    801ba3 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bd0:	8b 75 0c             	mov    0xc(%ebp),%esi
  801bd3:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 4: Your code here.
	if(!pg)
		pg=(void *)UTOP;
  801bd6:	85 db                	test   %ebx,%ebx
  801bd8:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801bdd:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801be0:	ff 75 14             	pushl  0x14(%ebp)
  801be3:	53                   	push   %ebx
  801be4:	56                   	push   %esi
  801be5:	57                   	push   %edi
  801be6:	e8 6d f1 ff ff       	call   800d58 <sys_ipc_try_send>
		if(!res)
  801beb:	83 c4 10             	add    $0x10,%esp
  801bee:	85 c0                	test   %eax,%eax
  801bf0:	74 20                	je     801c12 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bf2:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bf5:	75 07                	jne    801bfe <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801bf7:	e8 94 ef ff ff       	call   800b90 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bfc:	eb e2                	jmp    801be0 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bfe:	83 ec 04             	sub    $0x4,%esp
  801c01:	68 7b 23 80 00       	push   $0x80237b
  801c06:	6a 3f                	push   $0x3f
  801c08:	68 93 23 80 00       	push   $0x802393
  801c0d:	e8 f7 fe ff ff       	call   801b09 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c29:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c2c:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c32:	8b 52 50             	mov    0x50(%edx),%edx
  801c35:	39 ca                	cmp    %ecx,%edx
  801c37:	74 11                	je     801c4a <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c39:	83 c0 01             	add    $0x1,%eax
  801c3c:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c41:	75 e6                	jne    801c29 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c43:	b8 00 00 00 00       	mov    $0x0,%eax
  801c48:	eb 0b                	jmp    801c55 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801c4a:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801c4d:	05 00 00 c0 ee       	add    $0xeec00000,%eax
