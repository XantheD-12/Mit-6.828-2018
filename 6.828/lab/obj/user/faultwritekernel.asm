...
sys_env_destroy(envid_t envid)
{
  ...
  800123:	68 ea 1e 80 00       	push   $0x801eea
  800128:	6a 23                	push   $0x23
  80012a:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b0:	68 ea 1e 80 00       	push   $0x801eea
  8001b5:	6a 23                	push   $0x23
  8001b7:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f6:	68 ea 1e 80 00       	push   $0x801eea
  8001fb:	6a 23                	push   $0x23
  8001fd:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80023c:	68 ea 1e 80 00       	push   $0x801eea
  800241:	6a 23                	push   $0x23
  800243:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800282:	68 ea 1e 80 00       	push   $0x801eea
  800287:	6a 23                	push   $0x23
  800289:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002c8:	68 ea 1e 80 00       	push   $0x801eea
  8002cd:	6a 23                	push   $0x23
  8002cf:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80030e:	68 ea 1e 80 00       	push   $0x801eea
  800313:	6a 23                	push   $0x23
  800315:	68 07 1f 80 00       	push   $0x801f07
...
sys_ipc_recv(void *dstva)
{
  ...
  80037a:	68 ea 1e 80 00       	push   $0x801eea
  80037f:	6a 23                	push   $0x23
  800381:	68 07 1f 80 00       	push   $0x801f07
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800471:	ba 94 1f 80 00       	mov    $0x801f94,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800493:	51                   	push   %ecx
  800494:	50                   	push   %eax
  800495:	68 18 1f 80 00       	push   $0x801f18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800701:	53                   	push   %ebx
  800702:	50                   	push   %eax
  800703:	68 59 1f 80 00       	push   $0x801f59
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007d2:	53                   	push   %ebx
  8007d3:	50                   	push   %eax
  8007d4:	68 75 1f 80 00       	push   $0x801f75
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800882:	53                   	push   %ebx
  800883:	50                   	push   %eax
  800884:	68 38 1f 80 00       	push   $0x801f38
...
fsipc(unsigned type, void *dstva)
{
  ...
  80097a:	e8 21 12 00 00       	call   801ba0 <ipc_send>
  ...
  800998:	e8 5d 12 00 00       	call   801bfa <ipc_find_env>
...
00800a58 <devfile_write>:
{
  ...
  800a6a:	ba f8 0f 00 00       	mov    $0xff8,%edx
  800a6f:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  800a72:	8b 55 08             	mov    0x8(%ebp),%edx
  800a75:	8b 52 0c             	mov    0xc(%edx),%edx
  800a78:	89 15 00 50 80 00    	mov    %edx,0x805000
...
00800aa2 <devfile_read>:
{
  ...
  800afb:	c3                   	ret    
	assert(r <= n);
  800afc:	68 a4 1f 80 00       	push   $0x801fa4
  800b01:	68 ab 1f 80 00       	push   $0x801fab
  800b06:	6a 7d                	push   $0x7d
  800b08:	68 c0 1f 80 00       	push   $0x801fc0
  800b0d:	e8 be 05 00 00       	call   8010d0 <_panic>
	assert(r <= PGSIZE);
  800b12:	68 cb 1f 80 00       	push   $0x801fcb
  800b17:	68 ab 1f 80 00       	push   $0x801fab
  800b1c:	6a 7e                	push   $0x7e
  800b1e:	68 c0 1f 80 00       	push   $0x801fc0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bf1:	68 d7 1f 80 00       	push   $0x801fd7
  800bf6:	53                   	push   %ebx
...
00800c55 <_pipeisclosed>:
{
  ...
  800c6d:	57                   	push   %edi
  800c6e:	e8 c4 0f 00 00       	call   801c37 <pageref>
  800c73:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800c76:	89 34 24             	mov    %esi,(%esp)
  800c79:	e8 b9 0f 00 00       	call   801c37 <pageref>
		nn = thisenv->env_runs;
  ...
  800c98:	50                   	push   %eax
  800c99:	53                   	push   %ebx
  800c9a:	68 de 1f 80 00       	push   $0x801fde
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f4f:	68 f6 1f 80 00       	push   $0x801ff6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010f0:	56                   	push   %esi
  8010f1:	50                   	push   %eax
  8010f2:	68 04 20 80 00       	push   $0x802004
  ...
  801103:	e8 5a 00 00 00       	call   801162 <vcprintf>
	cprintf("\n");
  801108:	c7 04 24 ef 1f 80 00 	movl   $0x801fef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80121d:	e8 5e 0a 00 00       	call   801c80 <__udivdi3>
  ...
  80125b:	e8 30 0b 00 00       	call   801d90 <__umoddi3>
  801260:	83 c4 14             	add    $0x14,%esp
  801263:	0f be 80 27 20 80 00 	movsbl 0x802027(%eax),%eax
  80126a:	50                   	push   %eax
...
008012ba <vprintfmt>:
{
  ...
  80130a:	3e ff 24 85 60 21 80 	notrack jmp *0x802160(,%eax,4)
  801311:	00 
  ...
  8013d7:	8b 14 85 c0 22 80 00 	mov    0x8022c0(,%eax,4),%edx
  8013de:	85 d2                	test   %edx,%edx
  8013e0:	74 18                	je     8013fa <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8013e2:	52                   	push   %edx
  8013e3:	68 bd 1f 80 00       	push   $0x801fbd
  8013e8:	53                   	push   %ebx
  8013e9:	56                   	push   %esi
  ...
  8013fa:	50                   	push   %eax
  8013fb:	68 3f 20 80 00       	push   $0x80203f
  801400:	53                   	push   %ebx
  801401:	56                   	push   %esi
  ...
  801422:	b8 38 20 80 00       	mov    $0x802038,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b8c:	74 06                	je     801b94 <ipc_recv+0x61>
			*from_env_store=0;
  801b8e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801b94:	85 db                	test   %ebx,%ebx
  801b96:	74 eb                	je     801b83 <ipc_recv+0x50>
			*perm_store=0;
  801b98:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801b9e:	eb e3                	jmp    801b83 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bad:	8b 7d 08             	mov    0x8(%ebp),%edi
  ...
  801bb8:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801bbd:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bc0:	ff 75 14             	pushl  0x14(%ebp)
  801bc3:	53                   	push   %ebx
  801bc4:	56                   	push   %esi
  801bc5:	57                   	push   %edi
  801bc6:	e8 54 e7 ff ff       	call   80031f <sys_ipc_try_send>
		if(!res)
  801bcb:	83 c4 10             	add    $0x10,%esp
  801bce:	85 c0                	test   %eax,%eax
  801bd0:	74 20                	je     801bf2 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bd2:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bd5:	75 07                	jne    801bde <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801bd7:	e8 7b e5 ff ff       	call   800157 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bdc:	eb e2                	jmp    801bc0 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bde:	83 ec 04             	sub    $0x4,%esp
  801be1:	68 1f 23 80 00       	push   $0x80231f
  801be6:	6a 3f                	push   $0x3f
  801be8:	68 37 23 80 00       	push   $0x802337
  801bed:	e8 de f4 ff ff       	call   8010d0 <_panic>
	}
}
