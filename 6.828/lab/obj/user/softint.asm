...
sys_env_destroy(envid_t envid)
{
  ...
  80011b:	68 ea 1e 80 00       	push   $0x801eea
  800120:	6a 23                	push   $0x23
  800122:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a8:	68 ea 1e 80 00       	push   $0x801eea
  8001ad:	6a 23                	push   $0x23
  8001af:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ee:	68 ea 1e 80 00       	push   $0x801eea
  8001f3:	6a 23                	push   $0x23
  8001f5:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800234:	68 ea 1e 80 00       	push   $0x801eea
  800239:	6a 23                	push   $0x23
  80023b:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80027a:	68 ea 1e 80 00       	push   $0x801eea
  80027f:	6a 23                	push   $0x23
  800281:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002c0:	68 ea 1e 80 00       	push   $0x801eea
  8002c5:	6a 23                	push   $0x23
  8002c7:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800306:	68 ea 1e 80 00       	push   $0x801eea
  80030b:	6a 23                	push   $0x23
  80030d:	68 07 1f 80 00       	push   $0x801f07
...
sys_ipc_recv(void *dstva)
{
  ...
  800372:	68 ea 1e 80 00       	push   $0x801eea
  800377:	6a 23                	push   $0x23
  800379:	68 07 1f 80 00       	push   $0x801f07
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800469:	ba 94 1f 80 00       	mov    $0x801f94,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80048b:	51                   	push   %ecx
  80048c:	50                   	push   %eax
  80048d:	68 18 1f 80 00       	push   $0x801f18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006f9:	53                   	push   %ebx
  8006fa:	50                   	push   %eax
  8006fb:	68 59 1f 80 00       	push   $0x801f59
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007ca:	53                   	push   %ebx
  8007cb:	50                   	push   %eax
  8007cc:	68 75 1f 80 00       	push   $0x801f75
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80087a:	53                   	push   %ebx
  80087b:	50                   	push   %eax
  80087c:	68 38 1f 80 00       	push   $0x801f38
...
fsipc(unsigned type, void *dstva)
{
  ...
  800972:	e8 21 12 00 00       	call   801b98 <ipc_send>
  ...
  800990:	e8 5d 12 00 00       	call   801bf2 <ipc_find_env>
...
00800a50 <devfile_write>:
{
  ...
  800a62:	ba f8 0f 00 00       	mov    $0xff8,%edx
  800a67:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  800a6a:	8b 55 08             	mov    0x8(%ebp),%edx
  800a6d:	8b 52 0c             	mov    0xc(%edx),%edx
  800a70:	89 15 00 50 80 00    	mov    %edx,0x805000
...
00800a9a <devfile_read>:
{
  ...
  800af3:	c3                   	ret    
	assert(r <= n);
  800af4:	68 a4 1f 80 00       	push   $0x801fa4
  800af9:	68 ab 1f 80 00       	push   $0x801fab
  800afe:	6a 7d                	push   $0x7d
  800b00:	68 c0 1f 80 00       	push   $0x801fc0
  800b05:	e8 be 05 00 00       	call   8010c8 <_panic>
	assert(r <= PGSIZE);
  800b0a:	68 cb 1f 80 00       	push   $0x801fcb
  800b0f:	68 ab 1f 80 00       	push   $0x801fab
  800b14:	6a 7e                	push   $0x7e
  800b16:	68 c0 1f 80 00       	push   $0x801fc0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800be9:	68 d7 1f 80 00       	push   $0x801fd7
  800bee:	53                   	push   %ebx
...
00800c4d <_pipeisclosed>:
{
  ...
  800c65:	57                   	push   %edi
  800c66:	e8 c4 0f 00 00       	call   801c2f <pageref>
  800c6b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800c6e:	89 34 24             	mov    %esi,(%esp)
  800c71:	e8 b9 0f 00 00       	call   801c2f <pageref>
		nn = thisenv->env_runs;
  ...
  800c90:	50                   	push   %eax
  800c91:	53                   	push   %ebx
  800c92:	68 de 1f 80 00       	push   $0x801fde
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f47:	68 f6 1f 80 00       	push   $0x801ff6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010e8:	56                   	push   %esi
  8010e9:	50                   	push   %eax
  8010ea:	68 04 20 80 00       	push   $0x802004
  ...
  8010fb:	e8 5a 00 00 00       	call   80115a <vcprintf>
	cprintf("\n");
  801100:	c7 04 24 ef 1f 80 00 	movl   $0x801fef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801215:	e8 56 0a 00 00       	call   801c70 <__udivdi3>
  ...
  801253:	e8 28 0b 00 00       	call   801d80 <__umoddi3>
  801258:	83 c4 14             	add    $0x14,%esp
  80125b:	0f be 80 27 20 80 00 	movsbl 0x802027(%eax),%eax
  801262:	50                   	push   %eax
...
008012b2 <vprintfmt>:
{
  ...
  801302:	3e ff 24 85 60 21 80 	notrack jmp *0x802160(,%eax,4)
  801309:	00 
  ...
  8013cf:	8b 14 85 c0 22 80 00 	mov    0x8022c0(,%eax,4),%edx
  8013d6:	85 d2                	test   %edx,%edx
  8013d8:	74 18                	je     8013f2 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8013da:	52                   	push   %edx
  8013db:	68 bd 1f 80 00       	push   $0x801fbd
  8013e0:	53                   	push   %ebx
  8013e1:	56                   	push   %esi
  ...
  8013f2:	50                   	push   %eax
  8013f3:	68 3f 20 80 00       	push   $0x80203f
  8013f8:	53                   	push   %ebx
  8013f9:	56                   	push   %esi
  ...
  80141a:	b8 38 20 80 00       	mov    $0x802038,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b3f:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801b44:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801b47:	83 ec 0c             	sub    $0xc,%esp
  801b4a:	50                   	push   %eax
  801b4b:	e8 ee e7 ff ff       	call   80033e <sys_ipc_recv>
  801b50:	83 c4 10             	add    $0x10,%esp
  801b53:	85 c0                	test   %eax,%eax
  801b55:	78 2b                	js     801b82 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801b59:	74 0a                	je     801b65 <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  801b5b:	a1 04 40 80 00       	mov    0x804004,%eax
  801b60:	8b 40 74             	mov    0x74(%eax),%eax
  801b63:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801b65:	85 db                	test   %ebx,%ebx
  801b67:	74 0a                	je     801b73 <ipc_recv+0x48>
		*perm_store=thisenv->env_ipc_perm;
  801b69:	a1 04 40 80 00       	mov    0x804004,%eax
  801b6e:	8b 40 78             	mov    0x78(%eax),%eax
  801b71:	89 03                	mov    %eax,(%ebx)
  ...
  801b84:	74 06                	je     801b8c <ipc_recv+0x61>
			*from_env_store=0;
  801b86:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801b8c:	85 db                	test   %ebx,%ebx
  801b8e:	74 eb                	je     801b7b <ipc_recv+0x50>
			*perm_store=0;
  801b90:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801b96:	eb e3                	jmp    801b7b <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bb5:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bb8:	ff 75 14             	pushl  0x14(%ebp)
  801bbb:	53                   	push   %ebx
  801bbc:	56                   	push   %esi
  801bbd:	57                   	push   %edi
  801bbe:	e8 54 e7 ff ff       	call   800317 <sys_ipc_try_send>
		if(!res)
  801bc3:	83 c4 10             	add    $0x10,%esp
  801bc6:	85 c0                	test   %eax,%eax
  801bc8:	74 20                	je     801bea <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bca:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bcd:	75 07                	jne    801bd6 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801bcf:	e8 7b e5 ff ff       	call   80014f <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bd4:	eb e2                	jmp    801bb8 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bd6:	83 ec 04             	sub    $0x4,%esp
  801bd9:	68 1f 23 80 00       	push   $0x80231f
  801bde:	6a 3f                	push   $0x3f
  801be0:	68 37 23 80 00       	push   $0x802337
  801be5:	e8 de f4 ff ff       	call   8010c8 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c01:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c04:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c0a:	8b 52 50             	mov    0x50(%edx),%edx
  801c0d:	39 ca                	cmp    %ecx,%edx
  801c0f:	74 11                	je     801c22 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c11:	83 c0 01             	add    $0x1,%eax
  801c14:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c19:	75 e6                	jne    801c01 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c1b:	b8 00 00 00 00       	mov    $0x0,%eax
  801c20:	eb 0b                	jmp    801c2d <ipc_find_env+0x3b>
			return envs[i].env_id;
...
pageref(void *v)
{
  ...
  801c3e:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801c45:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801c4a:	f6 c1 01             	test   $0x1,%cl
  801c4d:	74 1c                	je     801c6b <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801c4f:	c1 e8 0c             	shr    $0xc,%eax
  801c52:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801c59:	a8 01                	test   $0x1,%al
  801c5b:	74 0e                	je     801c6b <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801c5d:	c1 e8 0c             	shr    $0xc,%eax
  801c60:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801c67:	ef 
  801c68:	0f b7 d2             	movzwl %dx,%edx
}
