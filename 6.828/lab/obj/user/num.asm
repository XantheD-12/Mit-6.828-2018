...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800224:	e8 5a 00 00 00       	call   800283 <vcprintf>
	cprintf("\n");
  800229:	c7 04 24 e3 25 80 00 	movl   $0x8025e3,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80033e:	e8 ad 1b 00 00       	call   801ef0 <__udivdi3>
  ...
  80037c:	e8 7f 1c 00 00       	call   802000 <__umoddi3>
...
fsipc(unsigned type, void *dstva)
{
  ...
  801524:	e8 e2 08 00 00       	call   801e0b <ipc_send>
  ...
  801542:	e8 1e 09 00 00       	call   801e65 <ipc_find_env>
...
00801923 <_pipeisclosed>:
{
  ...
  80193b:	57                   	push   %edi
  80193c:	e8 61 05 00 00       	call   801ea2 <pageref>
  801941:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801944:	89 34 24             	mov    %esi,(%esp)
  801947:	e8 56 05 00 00       	call   801ea2 <pageref>
		nn = thisenv->env_runs;
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801dcc:	74 0a                	je     801dd8 <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  801dce:	a1 08 40 80 00       	mov    0x804008,%eax
  801dd3:	8b 40 74             	mov    0x74(%eax),%eax
  801dd6:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801dd8:	85 db                	test   %ebx,%ebx
  801dda:	74 0a                	je     801de6 <ipc_recv+0x48>
  ...
  801df7:	74 06                	je     801dff <ipc_recv+0x61>
			*from_env_store=0;
  801df9:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801dff:	85 db                	test   %ebx,%ebx
  801e01:	74 eb                	je     801dee <ipc_recv+0x50>
			*perm_store=0;
  801e03:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801e09:	eb e3                	jmp    801dee <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801e23:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801e28:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801e2b:	ff 75 14             	pushl  0x14(%ebp)
  801e2e:	53                   	push   %ebx
  801e2f:	56                   	push   %esi
  801e30:	57                   	push   %edi
  801e31:	e8 93 f0 ff ff       	call   800ec9 <sys_ipc_try_send>
		if(!res)
  801e36:	83 c4 10             	add    $0x10,%esp
  801e39:	85 c0                	test   %eax,%eax
  801e3b:	74 20                	je     801e5d <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801e3d:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801e40:	75 07                	jne    801e49 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801e42:	e8 ba ee ff ff       	call   800d01 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801e47:	eb e2                	jmp    801e2b <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801e49:	83 ec 04             	sub    $0x4,%esp
  801e4c:	68 f6 25 80 00       	push   $0x8025f6
  801e51:	6a 3f                	push   $0x3f
  801e53:	68 0e 26 80 00       	push   $0x80260e
  801e58:	e8 94 e3 ff ff       	call   8001f1 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801e74:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801e77:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801e7d:	8b 52 50             	mov    0x50(%edx),%edx
  801e80:	39 ca                	cmp    %ecx,%edx
  801e82:	74 11                	je     801e95 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801e84:	83 c0 01             	add    $0x1,%eax
  801e87:	3d 00 04 00 00       	cmp    $0x400,%eax
  801e8c:	75 e6                	jne    801e74 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801e8e:	b8 00 00 00 00       	mov    $0x0,%eax
  801e93:	eb 0b                	jmp    801ea0 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801e95:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801e98:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801e9d:	8b 40 48             	mov    0x48(%eax),%eax
}
  801ea0:	5d                   	pop    %ebp
  801ea1:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801eae:	c1 ea 16             	shr    $0x16,%edx
  801eb1:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801eb8:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801ebd:	f6 c1 01             	test   $0x1,%cl
  801ec0:	74 1c                	je     801ede <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801ec2:	c1 e8 0c             	shr    $0xc,%eax
  801ec5:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801ecc:	a8 01                	test   $0x1,%al
  801ece:	74 0e                	je     801ede <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801ed0:	c1 e8 0c             	shr    $0xc,%eax
  801ed3:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801eda:	ef 
  801edb:	0f b7 d2             	movzwl %dx,%edx
}
