...
usage(void)
{
  ...
  80003d:	68 40 22 80 00       	push   $0x802240
...
umain(int argc, char **argv)
{
  ...
  8000c3:	57                   	push   %edi
  8000c4:	53                   	push   %ebx
  8000c5:	68 54 22 80 00       	push   $0x802254
  ...
  8000fe:	57                   	push   %edi
  8000ff:	53                   	push   %ebx
  800100:	68 54 22 80 00       	push   $0x802254
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800284:	e8 57 1d 00 00       	call   801fe0 <__udivdi3>
  ...
  8002c2:	e8 29 1e 00 00       	call   8020f0 <__umoddi3>
  8002c7:	83 c4 14             	add    $0x14,%esp
  8002ca:	0f be 80 86 22 80 00 	movsbl 0x802286(%eax),%eax
  8002d1:	50                   	push   %eax
...
00800321 <vprintfmt>:
{
  ...
  800371:	3e ff 24 85 c0 23 80 	notrack jmp *0x8023c0(,%eax,4)
  800378:	00 
  ...
  80043e:	8b 14 85 20 25 80 00 	mov    0x802520(,%eax,4),%edx
  800445:	85 d2                	test   %edx,%edx
  800447:	74 18                	je     800461 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800449:	52                   	push   %edx
  80044a:	68 51 26 80 00       	push   $0x802651
  80044f:	53                   	push   %ebx
  800450:	56                   	push   %esi
  ...
  800461:	50                   	push   %eax
  800462:	68 9e 22 80 00       	push   $0x80229e
  800467:	53                   	push   %ebx
  800468:	56                   	push   %esi
  ...
  800489:	b8 97 22 80 00       	mov    $0x802297,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c13:	68 7f 25 80 00       	push   $0x80257f
  800c18:	6a 23                	push   $0x23
  800c1a:	68 9c 25 80 00       	push   $0x80259c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca0:	68 7f 25 80 00       	push   $0x80257f
  800ca5:	6a 23                	push   $0x23
  800ca7:	68 9c 25 80 00       	push   $0x80259c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d2c:	68 7f 25 80 00       	push   $0x80257f
  800d31:	6a 23                	push   $0x23
  800d33:	68 9c 25 80 00       	push   $0x80259c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d72:	68 7f 25 80 00       	push   $0x80257f
  800d77:	6a 23                	push   $0x23
  800d79:	68 9c 25 80 00       	push   $0x80259c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800db8:	68 7f 25 80 00       	push   $0x80257f
  800dbd:	6a 23                	push   $0x23
  800dbf:	68 9c 25 80 00       	push   $0x80259c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dfe:	68 7f 25 80 00       	push   $0x80257f
  800e03:	6a 23                	push   $0x23
  800e05:	68 9c 25 80 00       	push   $0x80259c
...
sys_ipc_recv(void *dstva)
{
  ...
  800e6a:	68 7f 25 80 00       	push   $0x80257f
  800e6f:	6a 23                	push   $0x23
  800e71:	68 9c 25 80 00       	push   $0x80259c
...
argstart(int *argc, char **argv, struct Argstate *args)
{
  ...
  800e95:	ba 51 22 80 00       	mov    $0x802251,%edx
...
argnextvalue(struct Argstate *args)
{
  ...
  800f60:	89 43 0c             	mov    %eax,0xc(%ebx)
		args->curarg = "";
  800f63:	c7 43 08 51 22 80 00 	movl   $0x802251,0x8(%ebx)
		(*args->argc)--;
	} else {
		args->argvalue = 0;
		args->curarg = 0;
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010c0:	ba 28 26 80 00       	mov    $0x802628,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8010e2:	51                   	push   %ecx
  8010e3:	50                   	push   %eax
  8010e4:	68 ac 25 80 00       	push   $0x8025ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801350:	53                   	push   %ebx
  801351:	50                   	push   %eax
  801352:	68 ed 25 80 00       	push   $0x8025ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801421:	53                   	push   %ebx
  801422:	50                   	push   %eax
  801423:	68 09 26 80 00       	push   $0x802609
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8014d1:	53                   	push   %ebx
  8014d2:	50                   	push   %eax
  8014d3:	68 cc 25 80 00       	push   $0x8025cc
...
fsipc(unsigned type, void *dstva)
{
  ...
  8015c9:	e8 2c 09 00 00       	call   801efa <ipc_send>
  ...
  8015e7:	e8 68 09 00 00       	call   801f54 <ipc_find_env>
...
008016a7 <devfile_write>:
{
  ...
  8016b4:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  8016b9:	ba f8 0f 00 00       	mov    $0xff8,%edx
  8016be:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  8016c1:	8b 55 08             	mov    0x8(%ebp),%edx
  8016c4:	8b 52 0c             	mov    0xc(%edx),%edx
  8016c7:	89 15 00 50 80 00    	mov    %edx,0x805000
...
008016f1 <devfile_read>:
{
  ...
  80174a:	c3                   	ret    
	assert(r <= n);
  80174b:	68 38 26 80 00       	push   $0x802638
  801750:	68 3f 26 80 00       	push   $0x80263f
  801755:	6a 7d                	push   $0x7d
  801757:	68 54 26 80 00       	push   $0x802654
  80175c:	e8 e2 06 00 00       	call   801e43 <_panic>
	assert(r <= PGSIZE);
  801761:	68 5f 26 80 00       	push   $0x80265f
  801766:	68 3f 26 80 00       	push   $0x80263f
  80176b:	6a 7e                	push   $0x7e
  80176d:	68 54 26 80 00       	push   $0x802654
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801964:	68 6b 26 80 00       	push   $0x80266b
  801969:	53                   	push   %ebx
...
008019c8 <_pipeisclosed>:
{
  ...
  8019e0:	57                   	push   %edi
  8019e1:	e8 ab 05 00 00       	call   801f91 <pageref>
  8019e6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8019e9:	89 34 24             	mov    %esi,(%esp)
  8019ec:	e8 a0 05 00 00       	call   801f91 <pageref>
		nn = thisenv->env_runs;
  ...
  801a0b:	50                   	push   %eax
  801a0c:	53                   	push   %ebx
  801a0d:	68 72 26 80 00       	push   $0x802672
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801cc2:	68 8a 26 80 00       	push   $0x80268a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801e63:	56                   	push   %esi
  801e64:	50                   	push   %eax
  801e65:	68 98 26 80 00       	push   $0x802698
  ...
  801e76:	e8 4e e3 ff ff       	call   8001c9 <vcprintf>
	cprintf("\n");
  801e7b:	c7 04 24 50 22 80 00 	movl   $0x802250,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801eac:	50                   	push   %eax
  801ead:	e8 84 ef ff ff       	call   800e36 <sys_ipc_recv>
  801eb2:	83 c4 10             	add    $0x10,%esp
  801eb5:	85 c0                	test   %eax,%eax
  801eb7:	78 2b                	js     801ee4 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801ebb:	74 0a                	je     801ec7 <ipc_recv+0x3a>
  ...
  801ec9:	74 0a                	je     801ed5 <ipc_recv+0x48>
  ...
  801ee6:	74 06                	je     801eee <ipc_recv+0x61>
			*from_env_store=0;
  801ee8:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801eee:	85 db                	test   %ebx,%ebx
  801ef0:	74 eb                	je     801edd <ipc_recv+0x50>
			*perm_store=0;
  801ef2:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801ef8:	eb e3                	jmp    801edd <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f12:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  ...
  801f1e:	56                   	push   %esi
  801f1f:	57                   	push   %edi
  801f20:	e8 ea ee ff ff       	call   800e0f <sys_ipc_try_send>
		if(!res)
  801f25:	83 c4 10             	add    $0x10,%esp
  801f28:	85 c0                	test   %eax,%eax
  801f2a:	74 20                	je     801f4c <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801f2c:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801f2f:	75 07                	jne    801f38 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801f31:	e8 11 ed ff ff       	call   800c47 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801f36:	eb e2                	jmp    801f1a <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801f38:	83 ec 04             	sub    $0x4,%esp
  801f3b:	68 bb 26 80 00       	push   $0x8026bb
  801f40:	6a 3f                	push   $0x3f
  801f42:	68 d3 26 80 00       	push   $0x8026d3
  801f47:	e8 f7 fe ff ff       	call   801e43 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801f63:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801f66:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801f6c:	8b 52 50             	mov    0x50(%edx),%edx
  801f6f:	39 ca                	cmp    %ecx,%edx
  801f71:	74 11                	je     801f84 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801f73:	83 c0 01             	add    $0x1,%eax
  801f76:	3d 00 04 00 00       	cmp    $0x400,%eax
  801f7b:	75 e6                	jne    801f63 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801f7d:	b8 00 00 00 00       	mov    $0x0,%eax
  801f82:	eb 0b                	jmp    801f8f <ipc_find_env+0x3b>
			return envs[i].env_id;
  801f84:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801f87:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
pageref(void *v)
{
  ...
  801fa0:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801fa7:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801fac:	f6 c1 01             	test   $0x1,%cl
  801faf:	74 1c                	je     801fcd <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801fb1:	c1 e8 0c             	shr    $0xc,%eax
  801fb4:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801fbb:	a8 01                	test   $0x1,%al
  801fbd:	74 0e                	je     801fcd <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801fbf:	c1 e8 0c             	shr    $0xc,%eax
  801fc2:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801fc9:	ef 
  801fca:	0f b7 d2             	movzwl %dx,%edx
}
