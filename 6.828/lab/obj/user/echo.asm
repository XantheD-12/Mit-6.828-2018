...
umain(int argc, char **argv)
{
  ...
  80005c:	68 80 1f 80 00       	push   $0x801f80
  ...
  80008b:	68 83 1f 80 00       	push   $0x801f83
  ...
  8000d7:	68 93 20 80 00       	push   $0x802093
...
sys_env_destroy(envid_t envid)
{
  ...
  80057e:	68 8f 1f 80 00       	push   $0x801f8f
  800583:	6a 23                	push   $0x23
  800585:	68 ac 1f 80 00       	push   $0x801fac
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80060b:	68 8f 1f 80 00       	push   $0x801f8f
  800610:	6a 23                	push   $0x23
  800612:	68 ac 1f 80 00       	push   $0x801fac
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800651:	68 8f 1f 80 00       	push   $0x801f8f
  800656:	6a 23                	push   $0x23
  800658:	68 ac 1f 80 00       	push   $0x801fac
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800697:	68 8f 1f 80 00       	push   $0x801f8f
  80069c:	6a 23                	push   $0x23
  80069e:	68 ac 1f 80 00       	push   $0x801fac
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8006dd:	68 8f 1f 80 00       	push   $0x801f8f
  8006e2:	6a 23                	push   $0x23
  8006e4:	68 ac 1f 80 00       	push   $0x801fac
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800723:	68 8f 1f 80 00       	push   $0x801f8f
  800728:	6a 23                	push   $0x23
  80072a:	68 ac 1f 80 00       	push   $0x801fac
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800769:	68 8f 1f 80 00       	push   $0x801f8f
  80076e:	6a 23                	push   $0x23
  800770:	68 ac 1f 80 00       	push   $0x801fac
...
sys_ipc_recv(void *dstva)
{
  ...
  8007d5:	68 8f 1f 80 00       	push   $0x801f8f
  8007da:	6a 23                	push   $0x23
  8007dc:	68 ac 1f 80 00       	push   $0x801fac
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8008cc:	ba 38 20 80 00       	mov    $0x802038,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  8008ee:	51                   	push   %ecx
  8008ef:	50                   	push   %eax
  8008f0:	68 bc 1f 80 00       	push   $0x801fbc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800b5c:	53                   	push   %ebx
  800b5d:	50                   	push   %eax
  800b5e:	68 fd 1f 80 00       	push   $0x801ffd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800c2d:	53                   	push   %ebx
  800c2e:	50                   	push   %eax
  800c2f:	68 19 20 80 00       	push   $0x802019
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800cdd:	53                   	push   %ebx
  800cde:	50                   	push   %eax
  800cdf:	68 dc 1f 80 00       	push   $0x801fdc
...
fsipc(unsigned type, void *dstva)
{
  ...
  800dd5:	e8 6c 0e 00 00       	call   801c46 <ipc_send>
  ...
  800df3:	e8 a8 0e 00 00       	call   801ca0 <ipc_find_env>
...
00800eb3 <devfile_write>:
{
  ...
  800ec0:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  800ec5:	ba f8 0f 00 00       	mov    $0xff8,%edx
  800eca:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  800ecd:	8b 55 08             	mov    0x8(%ebp),%edx
  800ed0:	8b 52 0c             	mov    0xc(%edx),%edx
  800ed3:	89 15 00 50 80 00    	mov    %edx,0x805000
...
00800efd <devfile_read>:
{
  ...
  800f56:	c3                   	ret    
	assert(r <= n);
  800f57:	68 48 20 80 00       	push   $0x802048
  800f5c:	68 4f 20 80 00       	push   $0x80204f
  800f61:	6a 7d                	push   $0x7d
  800f63:	68 64 20 80 00       	push   $0x802064
  800f68:	e8 be 05 00 00       	call   80152b <_panic>
	assert(r <= PGSIZE);
  800f6d:	68 6f 20 80 00       	push   $0x80206f
  800f72:	68 4f 20 80 00       	push   $0x80204f
  800f77:	6a 7e                	push   $0x7e
  800f79:	68 64 20 80 00       	push   $0x802064
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80104c:	68 7b 20 80 00       	push   $0x80207b
  801051:	53                   	push   %ebx
...
008010b0 <_pipeisclosed>:
{
  ...
  8010c8:	57                   	push   %edi
  8010c9:	e8 0f 0c 00 00       	call   801cdd <pageref>
  8010ce:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8010d1:	89 34 24             	mov    %esi,(%esp)
  8010d4:	e8 04 0c 00 00       	call   801cdd <pageref>
		nn = thisenv->env_runs;
  ...
  8010f3:	50                   	push   %eax
  8010f4:	53                   	push   %ebx
  8010f5:	68 82 20 80 00       	push   $0x802082
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8013aa:	68 9a 20 80 00       	push   $0x80209a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80154b:	56                   	push   %esi
  80154c:	50                   	push   %eax
  80154d:	68 a8 20 80 00       	push   $0x8020a8
  ...
  80155e:	e8 5a 00 00 00       	call   8015bd <vcprintf>
	cprintf("\n");
  801563:	c7 04 24 93 20 80 00 	movl   $0x802093,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801678:	e8 a3 06 00 00       	call   801d20 <__udivdi3>
  ...
  8016b6:	e8 75 07 00 00       	call   801e30 <__umoddi3>
  8016bb:	83 c4 14             	add    $0x14,%esp
  8016be:	0f be 80 cb 20 80 00 	movsbl 0x8020cb(%eax),%eax
  8016c5:	50                   	push   %eax
...
00801715 <vprintfmt>:
{
  ...
  801765:	3e ff 24 85 00 22 80 	notrack jmp *0x802200(,%eax,4)
  80176c:	00 
  ...
  801832:	8b 14 85 60 23 80 00 	mov    0x802360(,%eax,4),%edx
  801839:	85 d2                	test   %edx,%edx
  80183b:	74 18                	je     801855 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  80183d:	52                   	push   %edx
  80183e:	68 61 20 80 00       	push   $0x802061
  801843:	53                   	push   %ebx
  801844:	56                   	push   %esi
  ...
  801855:	50                   	push   %eax
  801856:	68 e3 20 80 00       	push   $0x8020e3
  80185b:	53                   	push   %ebx
  80185c:	56                   	push   %esi
  ...
  80187d:	b8 dc 20 80 00       	mov    $0x8020dc,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801bf8:	50                   	push   %eax
  801bf9:	e8 a3 eb ff ff       	call   8007a1 <sys_ipc_recv>
  801bfe:	83 c4 10             	add    $0x10,%esp
  801c01:	85 c0                	test   %eax,%eax
  801c03:	78 2b                	js     801c30 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801c07:	74 0a                	je     801c13 <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  801c09:	a1 04 40 80 00       	mov    0x804004,%eax
  801c0e:	8b 40 74             	mov    0x74(%eax),%eax
  801c11:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801c13:	85 db                	test   %ebx,%ebx
  801c15:	74 0a                	je     801c21 <ipc_recv+0x48>
		*perm_store=thisenv->env_ipc_perm;
  801c17:	a1 04 40 80 00       	mov    0x804004,%eax
  801c1c:	8b 40 78             	mov    0x78(%eax),%eax
  801c1f:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  801c21:	a1 04 40 80 00       	mov    0x804004,%eax
  801c26:	8b 40 70             	mov    0x70(%eax),%eax
}
  ...
  801c32:	74 06                	je     801c3a <ipc_recv+0x61>
			*from_env_store=0;
  801c34:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801c3a:	85 db                	test   %ebx,%ebx
  801c3c:	74 eb                	je     801c29 <ipc_recv+0x50>
			*perm_store=0;
  801c3e:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801c44:	eb e3                	jmp    801c29 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c66:	ff 75 14             	pushl  0x14(%ebp)
  801c69:	53                   	push   %ebx
  801c6a:	56                   	push   %esi
  801c6b:	57                   	push   %edi
  801c6c:	e8 09 eb ff ff       	call   80077a <sys_ipc_try_send>
		if(!res)
  801c71:	83 c4 10             	add    $0x10,%esp
  801c74:	85 c0                	test   %eax,%eax
  801c76:	74 20                	je     801c98 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801c78:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c7b:	75 07                	jne    801c84 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801c7d:	e8 30 e9 ff ff       	call   8005b2 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801c82:	eb e2                	jmp    801c66 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801c84:	83 ec 04             	sub    $0x4,%esp
  801c87:	68 bf 23 80 00       	push   $0x8023bf
  801c8c:	6a 3f                	push   $0x3f
  801c8e:	68 d7 23 80 00       	push   $0x8023d7
  801c93:	e8 93 f8 ff ff       	call   80152b <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801caf:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801cb2:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801cb8:	8b 52 50             	mov    0x50(%edx),%edx
  801cbb:	39 ca                	cmp    %ecx,%edx
  801cbd:	74 11                	je     801cd0 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801cbf:	83 c0 01             	add    $0x1,%eax
  801cc2:	3d 00 04 00 00       	cmp    $0x400,%eax
  801cc7:	75 e6                	jne    801caf <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801cc9:	b8 00 00 00 00       	mov    $0x0,%eax
  801cce:	eb 0b                	jmp    801cdb <ipc_find_env+0x3b>
			return envs[i].env_id;
  801cd0:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801cd3:	05 00 00 c0 ee       	add    $0xeec00000,%eax
...
pageref(void *v)
{
  ...
  801ce9:	c1 ea 16             	shr    $0x16,%edx
  801cec:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801cf3:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801cf8:	f6 c1 01             	test   $0x1,%cl
  801cfb:	74 1c                	je     801d19 <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801cfd:	c1 e8 0c             	shr    $0xc,%eax
  801d00:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801d07:	a8 01                	test   $0x1,%al
  801d09:	74 0e                	je     801d19 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d0b:	c1 e8 0c             	shr    $0xc,%eax
  801d0e:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801d15:	ef 
  801d16:	0f b7 d2             	movzwl %dx,%edx
}
