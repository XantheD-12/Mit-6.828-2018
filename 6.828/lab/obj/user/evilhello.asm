...
sys_env_destroy(envid_t envid)
{
  ...
  80012f:	68 0a 1f 80 00       	push   $0x801f0a
  800134:	6a 23                	push   $0x23
  800136:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001bc:	68 0a 1f 80 00       	push   $0x801f0a
  8001c1:	6a 23                	push   $0x23
  8001c3:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800202:	68 0a 1f 80 00       	push   $0x801f0a
  800207:	6a 23                	push   $0x23
  800209:	68 27 1f 80 00       	push   $0x801f27
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800248:	68 0a 1f 80 00       	push   $0x801f0a
  80024d:	6a 23                	push   $0x23
  80024f:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028e:	68 0a 1f 80 00       	push   $0x801f0a
  800293:	6a 23                	push   $0x23
  800295:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002d4:	68 0a 1f 80 00       	push   $0x801f0a
  8002d9:	6a 23                	push   $0x23
  8002db:	68 27 1f 80 00       	push   $0x801f27
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80031a:	68 0a 1f 80 00       	push   $0x801f0a
  80031f:	6a 23                	push   $0x23
  800321:	68 27 1f 80 00       	push   $0x801f27
...
sys_ipc_recv(void *dstva)
{
  ...
  800386:	68 0a 1f 80 00       	push   $0x801f0a
  80038b:	6a 23                	push   $0x23
  80038d:	68 27 1f 80 00       	push   $0x801f27
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80047d:	ba b4 1f 80 00       	mov    $0x801fb4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80049f:	51                   	push   %ecx
  8004a0:	50                   	push   %eax
  8004a1:	68 38 1f 80 00       	push   $0x801f38
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80070d:	53                   	push   %ebx
  80070e:	50                   	push   %eax
  80070f:	68 79 1f 80 00       	push   $0x801f79
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007de:	53                   	push   %ebx
  8007df:	50                   	push   %eax
  8007e0:	68 95 1f 80 00       	push   $0x801f95
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80088e:	53                   	push   %ebx
  80088f:	50                   	push   %eax
  800890:	68 58 1f 80 00       	push   $0x801f58
...
fsipc(unsigned type, void *dstva)
{
  ...
  800986:	e8 21 12 00 00       	call   801bac <ipc_send>
  ...
  8009a4:	e8 5d 12 00 00       	call   801c06 <ipc_find_env>
...
00800a64 <devfile_write>:
{
  ...
  800a81:	8b 52 0c             	mov    0xc(%edx),%edx
  800a84:	89 15 00 50 80 00    	mov    %edx,0x805000
...
00800aae <devfile_read>:
{
  ...
  800b07:	c3                   	ret    
	assert(r <= n);
  800b08:	68 c4 1f 80 00       	push   $0x801fc4
  800b0d:	68 cb 1f 80 00       	push   $0x801fcb
  800b12:	6a 7d                	push   $0x7d
  800b14:	68 e0 1f 80 00       	push   $0x801fe0
  800b19:	e8 be 05 00 00       	call   8010dc <_panic>
	assert(r <= PGSIZE);
  800b1e:	68 eb 1f 80 00       	push   $0x801feb
  800b23:	68 cb 1f 80 00       	push   $0x801fcb
  800b28:	6a 7e                	push   $0x7e
  800b2a:	68 e0 1f 80 00       	push   $0x801fe0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bfd:	68 f7 1f 80 00       	push   $0x801ff7
  800c02:	53                   	push   %ebx
...
00800c61 <_pipeisclosed>:
{
  ...
  800c79:	57                   	push   %edi
  800c7a:	e8 c4 0f 00 00       	call   801c43 <pageref>
  800c7f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800c82:	89 34 24             	mov    %esi,(%esp)
  800c85:	e8 b9 0f 00 00       	call   801c43 <pageref>
		nn = thisenv->env_runs;
  ...
  800ca4:	50                   	push   %eax
  800ca5:	53                   	push   %ebx
  800ca6:	68 fe 1f 80 00       	push   $0x801ffe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f5b:	68 16 20 80 00       	push   $0x802016
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010fc:	56                   	push   %esi
  8010fd:	50                   	push   %eax
  8010fe:	68 24 20 80 00       	push   $0x802024
  ...
  80110f:	e8 5a 00 00 00       	call   80116e <vcprintf>
	cprintf("\n");
  801114:	c7 04 24 0f 20 80 00 	movl   $0x80200f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801229:	e8 62 0a 00 00       	call   801c90 <__udivdi3>
  ...
  801267:	e8 34 0b 00 00       	call   801da0 <__umoddi3>
  80126c:	83 c4 14             	add    $0x14,%esp
  80126f:	0f be 80 47 20 80 00 	movsbl 0x802047(%eax),%eax
  801276:	50                   	push   %eax
...
008012c6 <vprintfmt>:
{
  ...
  8013ee:	52                   	push   %edx
  8013ef:	68 dd 1f 80 00       	push   $0x801fdd
  8013f4:	53                   	push   %ebx
  8013f5:	56                   	push   %esi
  ...
  801406:	50                   	push   %eax
  801407:	68 5f 20 80 00       	push   $0x80205f
  80140c:	53                   	push   %ebx
  80140d:	56                   	push   %esi
  ...
  80142e:	b8 58 20 80 00       	mov    $0x802058,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b5e:	50                   	push   %eax
  801b5f:	e8 ee e7 ff ff       	call   800352 <sys_ipc_recv>
  801b64:	83 c4 10             	add    $0x10,%esp
  801b67:	85 c0                	test   %eax,%eax
  801b69:	78 2b                	js     801b96 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801b6d:	74 0a                	je     801b79 <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  801b6f:	a1 04 40 80 00       	mov    0x804004,%eax
  801b74:	8b 40 74             	mov    0x74(%eax),%eax
  801b77:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801b79:	85 db                	test   %ebx,%ebx
  801b7b:	74 0a                	je     801b87 <ipc_recv+0x48>
		*perm_store=thisenv->env_ipc_perm;
  801b7d:	a1 04 40 80 00       	mov    0x804004,%eax
  801b82:	8b 40 78             	mov    0x78(%eax),%eax
  801b85:	89 03                	mov    %eax,(%ebx)
  ...
  801b98:	74 06                	je     801ba0 <ipc_recv+0x61>
			*from_env_store=0;
  801b9a:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801ba0:	85 db                	test   %ebx,%ebx
  801ba2:	74 eb                	je     801b8f <ipc_recv+0x50>
			*perm_store=0;
  801ba4:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801baa:	eb e3                	jmp    801b8f <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bc4:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801bc9:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
  ...
  801bd0:	56                   	push   %esi
  801bd1:	57                   	push   %edi
  801bd2:	e8 54 e7 ff ff       	call   80032b <sys_ipc_try_send>
		if(!res)
  801bd7:	83 c4 10             	add    $0x10,%esp
  801bda:	85 c0                	test   %eax,%eax
  801bdc:	74 20                	je     801bfe <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bde:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801be1:	75 07                	jne    801bea <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801be3:	e8 7b e5 ff ff       	call   800163 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801be8:	eb e2                	jmp    801bcc <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bea:	83 ec 04             	sub    $0x4,%esp
  801bed:	68 3f 23 80 00       	push   $0x80233f
  801bf2:	6a 3f                	push   $0x3f
  801bf4:	68 57 23 80 00       	push   $0x802357
  801bf9:	e8 de f4 ff ff       	call   8010dc <_panic>
	}
}
