...
sys_env_destroy(envid_t envid)
{
  ...
  80011f:	68 ea 1e 80 00       	push   $0x801eea
  800124:	6a 23                	push   $0x23
  800126:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001ac:	68 ea 1e 80 00       	push   $0x801eea
  8001b1:	6a 23                	push   $0x23
  8001b3:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001f2:	68 ea 1e 80 00       	push   $0x801eea
  8001f7:	6a 23                	push   $0x23
  8001f9:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800238:	68 ea 1e 80 00       	push   $0x801eea
  80023d:	6a 23                	push   $0x23
  80023f:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80027e:	68 ea 1e 80 00       	push   $0x801eea
  800283:	6a 23                	push   $0x23
  800285:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002c4:	68 ea 1e 80 00       	push   $0x801eea
  8002c9:	6a 23                	push   $0x23
  8002cb:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80030a:	68 ea 1e 80 00       	push   $0x801eea
  80030f:	6a 23                	push   $0x23
  800311:	68 07 1f 80 00       	push   $0x801f07
...
sys_ipc_recv(void *dstva)
{
  ...
  800376:	68 ea 1e 80 00       	push   $0x801eea
  80037b:	6a 23                	push   $0x23
  80037d:	68 07 1f 80 00       	push   $0x801f07
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80046d:	ba 94 1f 80 00       	mov    $0x801f94,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80048f:	51                   	push   %ecx
  800490:	50                   	push   %eax
  800491:	68 18 1f 80 00       	push   $0x801f18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006fd:	53                   	push   %ebx
  8006fe:	50                   	push   %eax
  8006ff:	68 59 1f 80 00       	push   $0x801f59
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007ce:	53                   	push   %ebx
  8007cf:	50                   	push   %eax
  8007d0:	68 75 1f 80 00       	push   $0x801f75
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80087e:	53                   	push   %ebx
  80087f:	50                   	push   %eax
  800880:	68 38 1f 80 00       	push   $0x801f38
...
fsipc(unsigned type, void *dstva)
{
  ...
  800976:	e8 21 12 00 00       	call   801b9c <ipc_send>
  ...
  800994:	e8 5d 12 00 00       	call   801bf6 <ipc_find_env>
...
00800a54 <devfile_write>:
{
  ...
  800a61:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  800a66:	ba f8 0f 00 00       	mov    $0xff8,%edx
  800a6b:	0f 47 c2             	cmova  %edx,%eax
...
00800a9e <devfile_read>:
{
  ...
  800af7:	c3                   	ret    
	assert(r <= n);
  800af8:	68 a4 1f 80 00       	push   $0x801fa4
  800afd:	68 ab 1f 80 00       	push   $0x801fab
  800b02:	6a 7d                	push   $0x7d
  800b04:	68 c0 1f 80 00       	push   $0x801fc0
  800b09:	e8 be 05 00 00       	call   8010cc <_panic>
	assert(r <= PGSIZE);
  800b0e:	68 cb 1f 80 00       	push   $0x801fcb
  800b13:	68 ab 1f 80 00       	push   $0x801fab
  800b18:	6a 7e                	push   $0x7e
  800b1a:	68 c0 1f 80 00       	push   $0x801fc0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bed:	68 d7 1f 80 00       	push   $0x801fd7
  800bf2:	53                   	push   %ebx
...
00800c51 <_pipeisclosed>:
{
  ...
  800c69:	57                   	push   %edi
  800c6a:	e8 c4 0f 00 00       	call   801c33 <pageref>
  800c6f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800c72:	89 34 24             	mov    %esi,(%esp)
  800c75:	e8 b9 0f 00 00       	call   801c33 <pageref>
		nn = thisenv->env_runs;
  ...
  800c94:	50                   	push   %eax
  800c95:	53                   	push   %ebx
  800c96:	68 de 1f 80 00       	push   $0x801fde
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f4b:	68 f6 1f 80 00       	push   $0x801ff6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010ec:	56                   	push   %esi
  8010ed:	50                   	push   %eax
  8010ee:	68 04 20 80 00       	push   $0x802004
  ...
  8010ff:	e8 5a 00 00 00       	call   80115e <vcprintf>
	cprintf("\n");
  801104:	c7 04 24 ef 1f 80 00 	movl   $0x801fef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801219:	e8 62 0a 00 00       	call   801c80 <__udivdi3>
  ...
  801257:	e8 34 0b 00 00       	call   801d90 <__umoddi3>
  80125c:	83 c4 14             	add    $0x14,%esp
  80125f:	0f be 80 27 20 80 00 	movsbl 0x802027(%eax),%eax
  801266:	50                   	push   %eax
...
008012b6 <vprintfmt>:
{
  ...
  801306:	3e ff 24 85 60 21 80 	notrack jmp *0x802160(,%eax,4)
  80130d:	00 
  ...
  8013d3:	8b 14 85 c0 22 80 00 	mov    0x8022c0(,%eax,4),%edx
  8013da:	85 d2                	test   %edx,%edx
  8013dc:	74 18                	je     8013f6 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8013de:	52                   	push   %edx
  8013df:	68 bd 1f 80 00       	push   $0x801fbd
  8013e4:	53                   	push   %ebx
  8013e5:	56                   	push   %esi
  ...
  8013f6:	50                   	push   %eax
  8013f7:	68 3f 20 80 00       	push   $0x80203f
  8013fc:	53                   	push   %ebx
  8013fd:	56                   	push   %esi
  ...
  80141e:	b8 38 20 80 00       	mov    $0x802038,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b43:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801b48:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801b4b:	83 ec 0c             	sub    $0xc,%esp
  801b4e:	50                   	push   %eax
  801b4f:	e8 ee e7 ff ff       	call   800342 <sys_ipc_recv>
  801b54:	83 c4 10             	add    $0x10,%esp
  801b57:	85 c0                	test   %eax,%eax
  801b59:	78 2b                	js     801b86 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801b5d:	74 0a                	je     801b69 <ipc_recv+0x3a>
  ...
  801b6b:	74 0a                	je     801b77 <ipc_recv+0x48>
  ...
  801b88:	74 06                	je     801b90 <ipc_recv+0x61>
			*from_env_store=0;
  801b8a:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801b90:	85 db                	test   %ebx,%ebx
  801b92:	74 eb                	je     801b7f <ipc_recv+0x50>
			*perm_store=0;
  801b94:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801b9a:	eb e3                	jmp    801b7f <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bc0:	56                   	push   %esi
  801bc1:	57                   	push   %edi
  801bc2:	e8 54 e7 ff ff       	call   80031b <sys_ipc_try_send>
		if(!res)
  801bc7:	83 c4 10             	add    $0x10,%esp
  801bca:	85 c0                	test   %eax,%eax
  801bcc:	74 20                	je     801bee <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bce:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bd1:	75 07                	jne    801bda <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801bd3:	e8 7b e5 ff ff       	call   800153 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bd8:	eb e2                	jmp    801bbc <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bda:	83 ec 04             	sub    $0x4,%esp
  801bdd:	68 1f 23 80 00       	push   $0x80231f
  801be2:	6a 3f                	push   $0x3f
  801be4:	68 37 23 80 00       	push   $0x802337
  801be9:	e8 de f4 ff ff       	call   8010cc <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c05:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801c08:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801c0e:	8b 52 50             	mov    0x50(%edx),%edx
  801c11:	39 ca                	cmp    %ecx,%edx
  801c13:	74 11                	je     801c26 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c15:	83 c0 01             	add    $0x1,%eax
  801c18:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c1d:	75 e6                	jne    801c05 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c1f:	b8 00 00 00 00       	mov    $0x0,%eax
  801c24:	eb 0b                	jmp    801c31 <ipc_find_env+0x3b>
			return envs[i].env_id;
...
pageref(void *v)
{
  ...
  801c42:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801c49:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801c4e:	f6 c1 01             	test   $0x1,%cl
  801c51:	74 1c                	je     801c6f <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801c53:	c1 e8 0c             	shr    $0xc,%eax
  801c56:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801c5d:	a8 01                	test   $0x1,%al
  801c5f:	74 0e                	je     801c6f <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801c61:	c1 e8 0c             	shr    $0xc,%eax
  801c64:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801c6b:	ef 
  801c6c:	0f b7 d2             	movzwl %dx,%edx
}
