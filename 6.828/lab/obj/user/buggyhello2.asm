...
fsipc(unsigned type, void *dstva)
{
  ...
  80098a:	e8 21 12 00 00       	call   801bb0 <ipc_send>
  ...
  8009a8:	e8 5d 12 00 00       	call   801c0a <ipc_find_env>
...
00800a68 <devfile_write>:
{
  ...
  800a75:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  800a7a:	ba f8 0f 00 00       	mov    $0xff8,%edx
  800a7f:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  800a82:	8b 55 08             	mov    0x8(%ebp),%edx
  800a85:	8b 52 0c             	mov    0xc(%edx),%edx
  800a88:	89 15 00 50 80 00    	mov    %edx,0x805000
...
00800c65 <_pipeisclosed>:
{
  ...
  800c7d:	57                   	push   %edi
  800c7e:	e8 c4 0f 00 00       	call   801c47 <pageref>
  800c83:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800c86:	89 34 24             	mov    %esi,(%esp)
  800c89:	e8 b9 0f 00 00       	call   801c47 <pageref>
		nn = thisenv->env_runs;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801113:	e8 5a 00 00 00       	call   801172 <vcprintf>
	cprintf("\n");
  801118:	c7 04 24 1b 20 80 00 	movl   $0x80201b,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80122d:	e8 5e 0a 00 00       	call   801c90 <__udivdi3>
  ...
  80126b:	e8 30 0b 00 00       	call   801da0 <__umoddi3>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b62:	50                   	push   %eax
  801b63:	e8 ee e7 ff ff       	call   800356 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bd4:	56                   	push   %esi
  801bd5:	57                   	push   %edi
  801bd6:	e8 54 e7 ff ff       	call   80032f <sys_ipc_try_send>
		if(!res)
  ...
  801be5:	75 07                	jne    801bee <ipc_send+0x3e>
		...
		sys_yield();
  801be7:	e8 7b e5 ff ff       	call   800167 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bec:	eb e2                	jmp    801bd0 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bee:	83 ec 04             	sub    $0x4,%esp
  801bf1:	68 5f 23 80 00       	push   $0x80235f
  801bf6:	6a 3f                	push   $0x3f
  801bf8:	68 77 23 80 00       	push   $0x802377
  801bfd:	e8 de f4 ff ff       	call   8010e0 <_panic>
	}
}
