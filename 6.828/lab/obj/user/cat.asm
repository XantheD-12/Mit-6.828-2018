...
cat(int f, char *s)
{
  ...
  800079:	68 00 21 80 00       	push   $0x802100
  80007e:	6a 0d                	push   $0xd
  800080:	68 1b 21 80 00       	push   $0x80211b
  ...
  80009a:	68 26 21 80 00       	push   $0x802126
  80009f:	6a 0f                	push   $0xf
  8000a1:	68 1b 21 80 00       	push   $0x80211b
...
umain(int argc, char **argv)
{
  ...
  8000b8:	8b 7d 0c             	mov    0xc(%ebp),%edi
	...
	binaryname = "cat";
  8000bb:	c7 05 00 30 80 00 3b 	movl   $0x80213b,0x803000
  8000c2:	21 80 00 
	if (argc == 1)
		cat(0, "<stdin>");
	else
  ...
  8000d3:	68 3f 21 80 00       	push   $0x80213f
  ...
  8000f1:	68 47 21 80 00       	push   $0x802147
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8001bd:	56                   	push   %esi
  8001be:	50                   	push   %eax
  8001bf:	68 64 21 80 00       	push   $0x802164
  ...
  8001d0:	e8 5a 00 00 00       	call   80022f <vcprintf>
	cprintf("\n");
  8001d5:	c7 04 24 83 25 80 00 	movl   $0x802583,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ea:	e8 a1 1b 00 00       	call   801e90 <__udivdi3>
  ...
  800328:	e8 73 1c 00 00       	call   801fa0 <__umoddi3>
  80032d:	83 c4 14             	add    $0x14,%esp
  800330:	0f be 80 87 21 80 00 	movsbl 0x802187(%eax),%eax
  800337:	50                   	push   %eax
...
00800387 <vprintfmt>:
{
  ...
  8003d7:	3e ff 24 85 c0 22 80 	notrack jmp *0x8022c0(,%eax,4)
  8003de:	00 
  ...
  8004a4:	8b 14 85 20 24 80 00 	mov    0x802420(,%eax,4),%edx
  8004ab:	85 d2                	test   %edx,%edx
  8004ad:	74 18                	je     8004c7 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8004af:	52                   	push   %edx
  8004b0:	68 51 25 80 00       	push   $0x802551
  8004b5:	53                   	push   %ebx
  8004b6:	56                   	push   %esi
  ...
  8004c7:	50                   	push   %eax
  8004c8:	68 9f 21 80 00       	push   $0x80219f
  8004cd:	53                   	push   %ebx
  8004ce:	56                   	push   %esi
  ...
  8004ef:	b8 98 21 80 00       	mov    $0x802198,%eax
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d06:	68 7f 24 80 00       	push   $0x80247f
  800d0b:	6a 23                	push   $0x23
  800d0d:	68 9c 24 80 00       	push   $0x80249c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d4c:	68 7f 24 80 00       	push   $0x80247f
  800d51:	6a 23                	push   $0x23
  800d53:	68 9c 24 80 00       	push   $0x80249c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dd8:	68 7f 24 80 00       	push   $0x80247f
  800ddd:	6a 23                	push   $0x23
  800ddf:	68 9c 24 80 00       	push   $0x80249c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800e1e:	68 7f 24 80 00       	push   $0x80247f
  800e23:	6a 23                	push   $0x23
  800e25:	68 9c 24 80 00       	push   $0x80249c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e64:	68 7f 24 80 00       	push   $0x80247f
  800e69:	6a 23                	push   $0x23
  800e6b:	68 9c 24 80 00       	push   $0x80249c
...
sys_ipc_recv(void *dstva)
{
  ...
  800ed0:	68 7f 24 80 00       	push   $0x80247f
  800ed5:	6a 23                	push   $0x23
  800ed7:	68 9c 24 80 00       	push   $0x80249c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800fc7:	ba 28 25 80 00       	mov    $0x802528,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800fe9:	51                   	push   %ecx
  800fea:	50                   	push   %eax
  800feb:	68 ac 24 80 00       	push   $0x8024ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801257:	53                   	push   %ebx
  801258:	50                   	push   %eax
  801259:	68 ed 24 80 00       	push   $0x8024ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801328:	53                   	push   %ebx
  801329:	50                   	push   %eax
  80132a:	68 09 25 80 00       	push   $0x802509
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8013d8:	53                   	push   %ebx
  8013d9:	50                   	push   %eax
  8013da:	68 cc 24 80 00       	push   $0x8024cc
...
fsipc(unsigned type, void *dstva)
{
  ...
  8014d0:	e8 e2 08 00 00       	call   801db7 <ipc_send>
  ...
  8014ee:	e8 1e 09 00 00       	call   801e11 <ipc_find_env>
...
008015ae <devfile_write>:
{
  ...
  8015ce:	89 15 00 70 80 00    	mov    %edx,0x807000
...
008015f8 <devfile_read>:
{
  ...
  801651:	c3                   	ret    
	assert(r <= n);
  801652:	68 38 25 80 00       	push   $0x802538
  801657:	68 3f 25 80 00       	push   $0x80253f
  80165c:	6a 7d                	push   $0x7d
  80165e:	68 54 25 80 00       	push   $0x802554
  801663:	e8 35 eb ff ff       	call   80019d <_panic>
	assert(r <= PGSIZE);
  801668:	68 5f 25 80 00       	push   $0x80255f
  80166d:	68 3f 25 80 00       	push   $0x80253f
  801672:	6a 7e                	push   $0x7e
  801674:	68 54 25 80 00       	push   $0x802554
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80186b:	68 6b 25 80 00       	push   $0x80256b
  801870:	53                   	push   %ebx
...
008018cf <_pipeisclosed>:
{
  ...
  8018e7:	57                   	push   %edi
  8018e8:	e8 61 05 00 00       	call   801e4e <pageref>
  8018ed:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  8018f0:	89 34 24             	mov    %esi,(%esp)
  8018f3:	e8 56 05 00 00       	call   801e4e <pageref>
		nn = thisenv->env_runs;
  ...
  801912:	50                   	push   %eax
  801913:	53                   	push   %ebx
  801914:	68 72 25 80 00       	push   $0x802572
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801bc9:	68 8a 25 80 00       	push   $0x80258a
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d5e:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801d63:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801d66:	83 ec 0c             	sub    $0xc,%esp
  801d69:	50                   	push   %eax
  801d6a:	e8 2d f1 ff ff       	call   800e9c <sys_ipc_recv>
  801d6f:	83 c4 10             	add    $0x10,%esp
  801d72:	85 c0                	test   %eax,%eax
  801d74:	78 2b                	js     801da1 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801da3:	74 06                	je     801dab <ipc_recv+0x61>
			*from_env_store=0;
  801da5:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801dab:	85 db                	test   %ebx,%ebx
  801dad:	74 eb                	je     801d9a <ipc_recv+0x50>
			*perm_store=0;
  801daf:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801db5:	eb e3                	jmp    801d9a <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ddb:	56                   	push   %esi
  801ddc:	57                   	push   %edi
  801ddd:	e8 93 f0 ff ff       	call   800e75 <sys_ipc_try_send>
		if(!res)
  801de2:	83 c4 10             	add    $0x10,%esp
  801de5:	85 c0                	test   %eax,%eax
  801de7:	74 20                	je     801e09 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801de9:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801dec:	75 07                	jne    801df5 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801dee:	e8 ba ee ff ff       	call   800cad <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801df3:	eb e2                	jmp    801dd7 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801df5:	83 ec 04             	sub    $0x4,%esp
  801df8:	68 96 25 80 00       	push   $0x802596
  801dfd:	6a 3f                	push   $0x3f
  801dff:	68 ae 25 80 00       	push   $0x8025ae
  801e04:	e8 94 e3 ff ff       	call   80019d <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801e20:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801e23:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801e29:	8b 52 50             	mov    0x50(%edx),%edx
  801e2c:	39 ca                	cmp    %ecx,%edx
  801e2e:	74 11                	je     801e41 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801e30:	83 c0 01             	add    $0x1,%eax
  801e33:	3d 00 04 00 00       	cmp    $0x400,%eax
  801e38:	75 e6                	jne    801e20 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801e3a:	b8 00 00 00 00       	mov    $0x0,%eax
  801e3f:	eb 0b                	jmp    801e4c <ipc_find_env+0x3b>
			return envs[i].env_id;
  801e41:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801e44:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801e49:	8b 40 48             	mov    0x48(%eax),%eax
}
  801e4c:	5d                   	pop    %ebp
  801e4d:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801e5a:	c1 ea 16             	shr    $0x16,%edx
  801e5d:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801e64:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801e69:	f6 c1 01             	test   $0x1,%cl
  801e6c:	74 1c                	je     801e8a <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801e6e:	c1 e8 0c             	shr    $0xc,%eax
  801e71:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801e78:	a8 01                	test   $0x1,%al
  801e7a:	74 0e                	je     801e8a <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e7c:	c1 e8 0c             	shr    $0xc,%eax
  801e7f:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801e86:	ef 
  801e87:	0f b7 d2             	movzwl %dx,%edx
}
...
00801e90 <__udivdi3>:
  ...
  801e9b:	8b 54 24 3c          	mov    0x3c(%esp),%edx
  801e9f:	8b 6c 24 30          	mov    0x30(%esp),%ebp
  801ea3:	8b 74 24 34          	mov    0x34(%esp),%esi
  801ea7:	8b 5c 24 38          	mov    0x38(%esp),%ebx
  801eab:	85 d2                	test   %edx,%edx
  801ead:	75 19                	jne    801ec8 <__udivdi3+0x38>
  801eaf:	39 f3                	cmp    %esi,%ebx
  801eb1:	76 4d                	jbe    801f00 <__udivdi3+0x70>
  801eb3:	31 ff                	xor    %edi,%edi
  801eb5:	89 e8                	mov    %ebp,%eax
  801eb7:	89 f2                	mov    %esi,%edx
  801eb9:	f7 f3                	div    %ebx
  ...
  801eca:	76 14                	jbe    801ee0 <__udivdi3+0x50>
  ...
  801ee0:	0f bd fa             	bsr    %edx,%edi
  801ee3:	83 f7 1f             	xor    $0x1f,%edi
  801ee6:	75 48                	jne    801f30 <__udivdi3+0xa0>
  801ee8:	39 f2                	cmp    %esi,%edx
  801eea:	72 06                	jb     801ef2 <__udivdi3+0x62>
  801eec:	31 c0                	xor    %eax,%eax
  801eee:	39 eb                	cmp    %ebp,%ebx
  801ef0:	77 de                	ja     801ed0 <__udivdi3+0x40>
  801ef2:	b8 01 00 00 00       	mov    $0x1,%eax
  801ef7:	eb d7                	jmp    801ed0 <__udivdi3+0x40>
  801ef9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801f00:	89 d9                	mov    %ebx,%ecx
  801f02:	85 db                	test   %ebx,%ebx
  801f04:	75 0b                	jne    801f11 <__udivdi3+0x81>
  801f06:	b8 01 00 00 00       	mov    $0x1,%eax
  801f0b:	31 d2                	xor    %edx,%edx
  801f0d:	f7 f3                	div    %ebx
  801f0f:	89 c1                	mov    %eax,%ecx
  801f11:	31 d2                	xor    %edx,%edx
  801f13:	89 f0                	mov    %esi,%eax
  801f15:	f7 f1                	div    %ecx
  801f17:	89 c6                	mov    %eax,%esi
  801f19:	89 e8                	mov    %ebp,%eax
  801f1b:	89 f7                	mov    %esi,%edi
...
00801fa0 <__umoddi3>:
  ...
  801faf:	8b 74 24 30          	mov    0x30(%esp),%esi
  801fb3:	8b 5c 24 34          	mov    0x34(%esp),%ebx
  801fb7:	8b 7c 24 38          	mov    0x38(%esp),%edi
  801fbb:	85 c0                	test   %eax,%eax
  801fbd:	75 19                	jne    801fd8 <__umoddi3+0x38>
  801fbf:	39 df                	cmp    %ebx,%edi
  801fc1:	76 5d                	jbe    802020 <__umoddi3+0x80>
  801fc3:	89 f0                	mov    %esi,%eax
  801fc5:	89 da                	mov    %ebx,%edx
  801fc7:	f7 f7                	div    %edi
  ...
  801fda:	39 d8                	cmp    %ebx,%eax
  801fdc:	76 12                	jbe    801ff0 <__umoddi3+0x50>
  ...
  801ff6:	75 50                	jne    802048 <__umoddi3+0xa8>
  801ff8:	39 d8                	cmp    %ebx,%eax
  801ffa:	0f 82 e0 00 00 00    	jb     8020e0 <__umoddi3+0x140>
  802000:	89 d9                	mov    %ebx,%ecx
  802002:	39 f7                	cmp    %esi,%edi
  802004:	0f 86 d6 00 00 00    	jbe    8020e0 <__umoddi3+0x140>
  80200a:	89 d0                	mov    %edx,%eax
  80200c:	89 ca                	mov    %ecx,%edx
  ...
  802014:	5d                   	pop    %ebp
  802015:	c3                   	ret    
  802016:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  80203f:	eb 8c                	jmp    801fcd <__umoddi3+0x2d>
  802041:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  802048:	89 e9                	mov    %ebp,%ecx
  80204a:	ba 20 00 00 00       	mov    $0x20,%edx
  80204f:	29 ea                	sub    %ebp,%edx
  ...
  80205d:	8b 4c 24 08          	mov    0x8(%esp),%ecx
  802061:	89 54 24 04          	mov    %edx,0x4(%esp)
  802065:	8b 54 24 04          	mov    0x4(%esp),%edx
  802069:	09 c1                	or     %eax,%ecx
  ...
  80208f:	09 d8                	or     %ebx,%eax
  802091:	f7 74 24 08          	divl   0x8(%esp)
  802095:	89 d1                	mov    %edx,%ecx
  802097:	89 f3                	mov    %esi,%ebx
  802099:	f7 64 24 0c          	mull   0xc(%esp)
  80209d:	89 c6                	mov    %eax,%esi
  80209f:	89 d7                	mov    %edx,%edi
  8020a1:	39 d1                	cmp    %edx,%ecx
  8020a3:	72 06                	jb     8020ab <__umoddi3+0x10b>
  8020a5:	75 10                	jne    8020b7 <__umoddi3+0x117>
  8020a7:	39 c3                	cmp    %eax,%ebx
  8020a9:	73 0c                	jae    8020b7 <__umoddi3+0x117>
  8020ab:	2b 44 24 0c          	sub    0xc(%esp),%eax
  8020af:	1b 54 24 08          	sbb    0x8(%esp),%edx
  8020b3:	89 d7                	mov    %edx,%edi
  8020b5:	89 c6                	mov    %eax,%esi
  8020b7:	89 ca                	mov    %ecx,%edx
  8020b9:	0f b6 4c 24 04       	movzbl 0x4(%esp),%ecx
  8020be:	29 f3                	sub    %esi,%ebx
  8020c0:	19 fa                	sbb    %edi,%edx
  8020c2:	89 d0                	mov    %edx,%eax
  8020c4:	d3 e0                	shl    %cl,%eax
  8020c6:	89 e9                	mov    %ebp,%ecx
  8020c8:	d3 eb                	shr    %cl,%ebx
  ...
  8020e0:	29 fe                	sub    %edi,%esi
  8020e2:	19 c3                	sbb    %eax,%ebx
  8020e4:	89 f2                	mov    %esi,%edx
  8020e6:	89 d9                	mov    %ebx,%ecx
  8020e8:	e9 1d ff ff ff       	jmp    80200a <__umoddi3+0x6a>
