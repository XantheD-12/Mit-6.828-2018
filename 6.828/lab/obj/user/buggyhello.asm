...
sys_env_destroy(envid_t envid)
{
  ...
  80012c:	68 ea 1e 80 00       	push   $0x801eea
  800131:	6a 23                	push   $0x23
  800133:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001b9:	68 ea 1e 80 00       	push   $0x801eea
  8001be:	6a 23                	push   $0x23
  8001c0:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ff:	68 ea 1e 80 00       	push   $0x801eea
  800204:	6a 23                	push   $0x23
  800206:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800245:	68 ea 1e 80 00       	push   $0x801eea
  80024a:	6a 23                	push   $0x23
  80024c:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80028b:	68 ea 1e 80 00       	push   $0x801eea
  800290:	6a 23                	push   $0x23
  800292:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002d1:	68 ea 1e 80 00       	push   $0x801eea
  8002d6:	6a 23                	push   $0x23
  8002d8:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800317:	68 ea 1e 80 00       	push   $0x801eea
  80031c:	6a 23                	push   $0x23
  80031e:	68 07 1f 80 00       	push   $0x801f07
...
sys_ipc_recv(void *dstva)
{
  ...
  800383:	68 ea 1e 80 00       	push   $0x801eea
  800388:	6a 23                	push   $0x23
  80038a:	68 07 1f 80 00       	push   $0x801f07
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80047a:	ba 94 1f 80 00       	mov    $0x801f94,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80049c:	51                   	push   %ecx
  80049d:	50                   	push   %eax
  80049e:	68 18 1f 80 00       	push   $0x801f18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80070a:	53                   	push   %ebx
  80070b:	50                   	push   %eax
  80070c:	68 59 1f 80 00       	push   $0x801f59
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007db:	53                   	push   %ebx
  8007dc:	50                   	push   %eax
  8007dd:	68 75 1f 80 00       	push   $0x801f75
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80088b:	53                   	push   %ebx
  80088c:	50                   	push   %eax
  80088d:	68 38 1f 80 00       	push   $0x801f38
...
fsipc(unsigned type, void *dstva)
{
  ...
  800983:	e8 21 12 00 00       	call   801ba9 <ipc_send>
  ...
  8009a1:	e8 5d 12 00 00       	call   801c03 <ipc_find_env>
...
00800aab <devfile_read>:
{
  ...
  800b04:	c3                   	ret    
	assert(r <= n);
  800b05:	68 a4 1f 80 00       	push   $0x801fa4
  800b0a:	68 ab 1f 80 00       	push   $0x801fab
  800b0f:	6a 7d                	push   $0x7d
  800b11:	68 c0 1f 80 00       	push   $0x801fc0
  800b16:	e8 be 05 00 00       	call   8010d9 <_panic>
	assert(r <= PGSIZE);
  800b1b:	68 cb 1f 80 00       	push   $0x801fcb
  800b20:	68 ab 1f 80 00       	push   $0x801fab
  800b25:	6a 7e                	push   $0x7e
  800b27:	68 c0 1f 80 00       	push   $0x801fc0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bfa:	68 d7 1f 80 00       	push   $0x801fd7
  800bff:	53                   	push   %ebx
...
00800c5e <_pipeisclosed>:
{
  ...
  800c76:	57                   	push   %edi
  800c77:	e8 c4 0f 00 00       	call   801c40 <pageref>
  800c7c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  800c7f:	89 34 24             	mov    %esi,(%esp)
  800c82:	e8 b9 0f 00 00       	call   801c40 <pageref>
		nn = thisenv->env_runs;
  ...
  800ca1:	50                   	push   %eax
  800ca2:	53                   	push   %ebx
  800ca3:	68 de 1f 80 00       	push   $0x801fde
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f58:	68 f6 1f 80 00       	push   $0x801ff6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010f9:	56                   	push   %esi
  8010fa:	50                   	push   %eax
  8010fb:	68 04 20 80 00       	push   $0x802004
  ...
  80110c:	e8 5a 00 00 00       	call   80116b <vcprintf>
	cprintf("\n");
  801111:	c7 04 24 ef 1f 80 00 	movl   $0x801fef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801226:	e8 55 0a 00 00       	call   801c80 <__udivdi3>
  ...
  801264:	e8 27 0b 00 00       	call   801d90 <__umoddi3>
  801269:	83 c4 14             	add    $0x14,%esp
  80126c:	0f be 80 27 20 80 00 	movsbl 0x802027(%eax),%eax
  801273:	50                   	push   %eax
...
008012c3 <vprintfmt>:
{
  ...
  801313:	3e ff 24 85 60 21 80 	notrack jmp *0x802160(,%eax,4)
  80131a:	00 
  ...
  8013e0:	8b 14 85 c0 22 80 00 	mov    0x8022c0(,%eax,4),%edx
  8013e7:	85 d2                	test   %edx,%edx
  8013e9:	74 18                	je     801403 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8013eb:	52                   	push   %edx
  8013ec:	68 bd 1f 80 00       	push   $0x801fbd
  8013f1:	53                   	push   %ebx
  8013f2:	56                   	push   %esi
  ...
  801403:	50                   	push   %eax
  801404:	68 3f 20 80 00       	push   $0x80203f
  801409:	53                   	push   %ebx
  80140a:	56                   	push   %esi
  ...
  80142b:	b8 38 20 80 00       	mov    $0x802038,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b71:	8b 40 74             	mov    0x74(%eax),%eax
  ...
  801b95:	74 06                	je     801b9d <ipc_recv+0x61>
			*from_env_store=0;
  801b97:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801b9d:	85 db                	test   %ebx,%ebx
  801b9f:	74 eb                	je     801b8c <ipc_recv+0x50>
			*perm_store=0;
  801ba1:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801ba7:	eb e3                	jmp    801b8c <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801bcd:	56                   	push   %esi
  801bce:	57                   	push   %edi
  801bcf:	e8 54 e7 ff ff       	call   800328 <sys_ipc_try_send>
		if(!res)
  801bd4:	83 c4 10             	add    $0x10,%esp
  801bd7:	85 c0                	test   %eax,%eax
  801bd9:	74 20                	je     801bfb <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bdb:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bde:	75 07                	jne    801be7 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801be0:	e8 7b e5 ff ff       	call   800160 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801be5:	eb e2                	jmp    801bc9 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801be7:	83 ec 04             	sub    $0x4,%esp
  801bea:	68 1f 23 80 00       	push   $0x80231f
  801bef:	6a 3f                	push   $0x3f
  801bf1:	68 37 23 80 00       	push   $0x802337
  801bf6:	e8 de f4 ff ff       	call   8010d9 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801c20:	74 11                	je     801c33 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801c22:	83 c0 01             	add    $0x1,%eax
  801c25:	3d 00 04 00 00       	cmp    $0x400,%eax
  801c2a:	75 e6                	jne    801c12 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801c2c:	b8 00 00 00 00       	mov    $0x0,%eax
  801c31:	eb 0b                	jmp    801c3e <ipc_find_env+0x3b>
			return envs[i].env_id;
  801c33:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801c36:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801c3b:	8b 40 48             	mov    0x48(%eax),%eax
}
  801c3e:	5d                   	pop    %ebp
  801c3f:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801c4f:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801c56:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801c5b:	f6 c1 01             	test   $0x1,%cl
  801c5e:	74 1c                	je     801c7c <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801c60:	c1 e8 0c             	shr    $0xc,%eax
  801c63:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801c6a:	a8 01                	test   $0x1,%al
  801c6c:	74 0e                	je     801c7c <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801c6e:	c1 e8 0c             	shr    $0xc,%eax
  801c71:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801c78:	ef 
  801c79:	0f b7 d2             	movzwl %dx,%edx
}
