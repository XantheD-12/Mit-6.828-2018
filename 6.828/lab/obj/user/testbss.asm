...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800168:	56                   	push   %esi
  800169:	50                   	push   %eax
  80016a:	68 48 20 80 00       	push   $0x802048
  ...
  80017b:	e8 5a 00 00 00       	call   8001da <vcprintf>
	cprintf("\n");
  800180:	c7 04 24 16 20 80 00 	movl   $0x802016,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800295:	e8 86 1a 00 00       	call   801d20 <__udivdi3>
  ...
  8002d3:	e8 58 1b 00 00       	call   801e30 <__umoddi3>
  8002d8:	83 c4 14             	add    $0x14,%esp
  8002db:	0f be 80 6b 20 80 00 	movsbl 0x80206b(%eax),%eax
  8002e2:	50                   	push   %eax
...
00800332 <vprintfmt>:
{
  ...
  800382:	3e ff 24 85 a0 21 80 	notrack jmp *0x8021a0(,%eax,4)
  800389:	00 
  ...
  80044f:	8b 14 85 00 23 80 00 	mov    0x802300(,%eax,4),%edx
  800456:	85 d2                	test   %edx,%edx
  800458:	74 18                	je     800472 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  80045a:	52                   	push   %edx
  80045b:	68 31 24 80 00       	push   $0x802431
  800460:	53                   	push   %ebx
  800461:	56                   	push   %esi
  ...
  800472:	50                   	push   %eax
  800473:	68 83 20 80 00       	push   $0x802083
  800478:	53                   	push   %ebx
  800479:	56                   	push   %esi
  ...
  80049a:	b8 7c 20 80 00       	mov    $0x80207c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c24:	68 5f 23 80 00       	push   $0x80235f
  800c29:	6a 23                	push   $0x23
  800c2b:	68 7c 23 80 00       	push   $0x80237c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cb1:	68 5f 23 80 00       	push   $0x80235f
  800cb6:	6a 23                	push   $0x23
  800cb8:	68 7c 23 80 00       	push   $0x80237c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf7:	68 5f 23 80 00       	push   $0x80235f
  800cfc:	6a 23                	push   $0x23
  800cfe:	68 7c 23 80 00       	push   $0x80237c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d3d:	68 5f 23 80 00       	push   $0x80235f
  800d42:	6a 23                	push   $0x23
  800d44:	68 7c 23 80 00       	push   $0x80237c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d83:	68 5f 23 80 00       	push   $0x80235f
  800d88:	6a 23                	push   $0x23
  800d8a:	68 7c 23 80 00       	push   $0x80237c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800dc9:	68 5f 23 80 00       	push   $0x80235f
  800dce:	6a 23                	push   $0x23
  800dd0:	68 7c 23 80 00       	push   $0x80237c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0f:	68 5f 23 80 00       	push   $0x80235f
  800e14:	6a 23                	push   $0x23
  800e16:	68 7c 23 80 00       	push   $0x80237c
...
sys_ipc_recv(void *dstva)
{
  ...
  800e7b:	68 5f 23 80 00       	push   $0x80235f
  800e80:	6a 23                	push   $0x23
  800e82:	68 7c 23 80 00       	push   $0x80237c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800f72:	ba 08 24 80 00       	mov    $0x802408,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800f94:	51                   	push   %ecx
  800f95:	50                   	push   %eax
  800f96:	68 8c 23 80 00       	push   $0x80238c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801202:	53                   	push   %ebx
  801203:	50                   	push   %eax
  801204:	68 cd 23 80 00       	push   $0x8023cd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8012d3:	53                   	push   %ebx
  8012d4:	50                   	push   %eax
  8012d5:	68 e9 23 80 00       	push   $0x8023e9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801383:	53                   	push   %ebx
  801384:	50                   	push   %eax
  801385:	68 ac 23 80 00       	push   $0x8023ac
...
fsipc(unsigned type, void *dstva)
{
  ...
  80147b:	e8 be 07 00 00       	call   801c3e <ipc_send>
  ...
  801499:	e8 fa 07 00 00       	call   801c98 <ipc_find_env>
...
00801559 <devfile_write>:
{
  ...
  801566:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  80156b:	ba f8 0f 00 00       	mov    $0xff8,%edx
  801570:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  801573:	8b 55 08             	mov    0x8(%ebp),%edx
  801576:	8b 52 0c             	mov    0xc(%edx),%edx
  801579:	89 15 00 50 c0 00    	mov    %edx,0xc05000
...
008015a3 <devfile_read>:
{
  ...
  8015fc:	c3                   	ret    
	assert(r <= n);
  8015fd:	68 18 24 80 00       	push   $0x802418
  801602:	68 1f 24 80 00       	push   $0x80241f
  801607:	6a 7d                	push   $0x7d
  801609:	68 34 24 80 00       	push   $0x802434
  80160e:	e8 35 eb ff ff       	call   800148 <_panic>
	assert(r <= PGSIZE);
  801613:	68 3f 24 80 00       	push   $0x80243f
  801618:	68 1f 24 80 00       	push   $0x80241f
  80161d:	6a 7e                	push   $0x7e
  80161f:	68 34 24 80 00       	push   $0x802434
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8016f2:	68 4b 24 80 00       	push   $0x80244b
  8016f7:	53                   	push   %ebx
...
00801756 <_pipeisclosed>:
{
  ...
  80176e:	57                   	push   %edi
  80176f:	e8 61 05 00 00       	call   801cd5 <pageref>
  801774:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801777:	89 34 24             	mov    %esi,(%esp)
  80177a:	e8 56 05 00 00       	call   801cd5 <pageref>
		nn = thisenv->env_runs;
  ...
  801799:	50                   	push   %eax
  80179a:	53                   	push   %ebx
  80179b:	68 52 24 80 00       	push   $0x802452
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801a50:	68 6a 24 80 00       	push   $0x80246a
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801be5:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801bea:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801bed:	83 ec 0c             	sub    $0xc,%esp
  801bf0:	50                   	push   %eax
  801bf1:	e8 51 f2 ff ff       	call   800e47 <sys_ipc_recv>
  801bf6:	83 c4 10             	add    $0x10,%esp
  801bf9:	85 c0                	test   %eax,%eax
  801bfb:	78 2b                	js     801c28 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
  ...
  801bff:	74 0a                	je     801c0b <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  801c01:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801c06:	8b 40 74             	mov    0x74(%eax),%eax
  801c09:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801c0b:	85 db                	test   %ebx,%ebx
  801c0d:	74 0a                	je     801c19 <ipc_recv+0x48>
		*perm_store=thisenv->env_ipc_perm;
  801c0f:	a1 20 40 c0 00       	mov    0xc04020,%eax
  801c14:	8b 40 78             	mov    0x78(%eax),%eax
  801c17:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  801c19:	a1 20 40 c0 00       	mov    0xc04020,%eax
  ...
  801c2a:	74 06                	je     801c32 <ipc_recv+0x61>
			*from_env_store=0;
  801c2c:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801c32:	85 db                	test   %ebx,%ebx
  801c34:	74 eb                	je     801c21 <ipc_recv+0x50>
			*perm_store=0;
  801c36:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801c3c:	eb e3                	jmp    801c21 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c62:	56                   	push   %esi
  801c63:	57                   	push   %edi
  801c64:	e8 b7 f1 ff ff       	call   800e20 <sys_ipc_try_send>
		if(!res)
  801c69:	83 c4 10             	add    $0x10,%esp
  801c6c:	85 c0                	test   %eax,%eax
  801c6e:	74 20                	je     801c90 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801c70:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801c73:	75 07                	jne    801c7c <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801c75:	e8 de ef ff ff       	call   800c58 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801c7a:	eb e2                	jmp    801c5e <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801c7c:	83 ec 04             	sub    $0x4,%esp
  801c7f:	68 76 24 80 00       	push   $0x802476
  801c84:	6a 3f                	push   $0x3f
  801c86:	68 8e 24 80 00       	push   $0x80248e
  801c8b:	e8 b8 e4 ff ff       	call   800148 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801ca7:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801caa:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801cb0:	8b 52 50             	mov    0x50(%edx),%edx
  801cb3:	39 ca                	cmp    %ecx,%edx
  801cb5:	74 11                	je     801cc8 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801cb7:	83 c0 01             	add    $0x1,%eax
  801cba:	3d 00 04 00 00       	cmp    $0x400,%eax
  801cbf:	75 e6                	jne    801ca7 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801cc1:	b8 00 00 00 00       	mov    $0x0,%eax
  801cc6:	eb 0b                	jmp    801cd3 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801cc8:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801ccb:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801cd0:	8b 40 48             	mov    0x48(%eax),%eax
}
  801cd3:	5d                   	pop    %ebp
  801cd4:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801ce1:	c1 ea 16             	shr    $0x16,%edx
  801ce4:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801ceb:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801cf0:	f6 c1 01             	test   $0x1,%cl
  801cf3:	74 1c                	je     801d11 <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801cf5:	c1 e8 0c             	shr    $0xc,%eax
  801cf8:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801cff:	a8 01                	test   $0x1,%al
  801d01:	74 0e                	je     801d11 <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801d03:	c1 e8 0c             	shr    $0xc,%eax
  801d06:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801d0d:	ef 
  801d0e:	0f b7 d2             	movzwl %dx,%edx
}
