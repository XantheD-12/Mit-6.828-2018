...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800266:	56                   	push   %esi
  800267:	50                   	push   %eax
  800268:	68 18 21 80 00       	push   $0x802118
  ...
  800279:	e8 5a 00 00 00       	call   8002d8 <vcprintf>
	cprintf("\n");
  80027e:	c7 04 24 0b 21 80 00 	movl   $0x80210b,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800393:	e8 88 1a 00 00       	call   801e20 <__udivdi3>
  ...
  8003d1:	e8 5a 1b 00 00       	call   801f30 <__umoddi3>
  8003d6:	83 c4 14             	add    $0x14,%esp
  8003d9:	0f be 80 3b 21 80 00 	movsbl 0x80213b(%eax),%eax
  8003e0:	50                   	push   %eax
...
00800430 <vprintfmt>:
{
  ...
  800480:	3e ff 24 85 80 22 80 	notrack jmp *0x802280(,%eax,4)
  800487:	00 
  ...
  80054d:	8b 14 85 e0 23 80 00 	mov    0x8023e0(,%eax,4),%edx
  800554:	85 d2                	test   %edx,%edx
  800556:	74 18                	je     800570 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  800558:	52                   	push   %edx
  800559:	68 11 25 80 00       	push   $0x802511
  80055e:	53                   	push   %ebx
  80055f:	56                   	push   %esi
  ...
  800570:	50                   	push   %eax
  800571:	68 53 21 80 00       	push   $0x802153
  800576:	53                   	push   %ebx
  800577:	56                   	push   %esi
  ...
  800598:	b8 4c 21 80 00       	mov    $0x80214c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800d22:	68 3f 24 80 00       	push   $0x80243f
  800d27:	6a 23                	push   $0x23
  800d29:	68 5c 24 80 00       	push   $0x80245c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800daf:	68 3f 24 80 00       	push   $0x80243f
  800db4:	6a 23                	push   $0x23
  800db6:	68 5c 24 80 00       	push   $0x80245c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800df5:	68 3f 24 80 00       	push   $0x80243f
  800dfa:	6a 23                	push   $0x23
  800dfc:	68 5c 24 80 00       	push   $0x80245c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e3b:	68 3f 24 80 00       	push   $0x80243f
  800e40:	6a 23                	push   $0x23
  800e42:	68 5c 24 80 00       	push   $0x80245c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e81:	68 3f 24 80 00       	push   $0x80243f
  800e86:	6a 23                	push   $0x23
  800e88:	68 5c 24 80 00       	push   $0x80245c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800ec7:	68 3f 24 80 00       	push   $0x80243f
  800ecc:	6a 23                	push   $0x23
  800ece:	68 5c 24 80 00       	push   $0x80245c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f0d:	68 3f 24 80 00       	push   $0x80243f
  800f12:	6a 23                	push   $0x23
  800f14:	68 5c 24 80 00       	push   $0x80245c
...
sys_ipc_recv(void *dstva)
{
  ...
  800f79:	68 3f 24 80 00       	push   $0x80243f
  800f7e:	6a 23                	push   $0x23
  800f80:	68 5c 24 80 00       	push   $0x80245c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801070:	ba e8 24 80 00       	mov    $0x8024e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  801092:	51                   	push   %ecx
  801093:	50                   	push   %eax
  801094:	68 6c 24 80 00       	push   $0x80246c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801300:	53                   	push   %ebx
  801301:	50                   	push   %eax
  801302:	68 ad 24 80 00       	push   $0x8024ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8013d1:	53                   	push   %ebx
  8013d2:	50                   	push   %eax
  8013d3:	68 c9 24 80 00       	push   $0x8024c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801481:	53                   	push   %ebx
  801482:	50                   	push   %eax
  801483:	68 8c 24 80 00       	push   $0x80248c
...
fsipc(unsigned type, void *dstva)
{
  ...
  801579:	e8 be 07 00 00       	call   801d3c <ipc_send>
  ...
  801597:	e8 fa 07 00 00       	call   801d96 <ipc_find_env>
...
00801657 <devfile_write>:
{
  ...
  801664:	3d f8 0f 00 00       	cmp    $0xff8,%eax
  801669:	ba f8 0f 00 00       	mov    $0xff8,%edx
  80166e:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  801671:	8b 55 08             	mov    0x8(%ebp),%edx
  801674:	8b 52 0c             	mov    0xc(%edx),%edx
  801677:	89 15 00 50 80 00    	mov    %edx,0x805000
...
008016a1 <devfile_read>:
{
  ...
  8016fa:	c3                   	ret    
	assert(r <= n);
  8016fb:	68 f8 24 80 00       	push   $0x8024f8
  801700:	68 ff 24 80 00       	push   $0x8024ff
  801705:	6a 7d                	push   $0x7d
  801707:	68 14 25 80 00       	push   $0x802514
  80170c:	e8 35 eb ff ff       	call   800246 <_panic>
	assert(r <= PGSIZE);
  801711:	68 1f 25 80 00       	push   $0x80251f
  801716:	68 ff 24 80 00       	push   $0x8024ff
  80171b:	6a 7e                	push   $0x7e
  80171d:	68 14 25 80 00       	push   $0x802514
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8017f0:	68 2b 25 80 00       	push   $0x80252b
  8017f5:	53                   	push   %ebx
...
00801854 <_pipeisclosed>:
{
  ...
  80186c:	57                   	push   %edi
  80186d:	e8 61 05 00 00       	call   801dd3 <pageref>
  801872:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801875:	89 34 24             	mov    %esi,(%esp)
  801878:	e8 56 05 00 00       	call   801dd3 <pageref>
		nn = thisenv->env_runs;
  ...
  801897:	50                   	push   %eax
  801898:	53                   	push   %ebx
  801899:	68 32 25 80 00       	push   $0x802532
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801b4e:	68 4a 25 80 00       	push   $0x80254a
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ce3:	ba 00 00 c0 ee       	mov    $0xeec00000,%edx
  801ce8:	0f 44 c2             	cmove  %edx,%eax
	int res;
	if((res=sys_ipc_recv(pg))<0){
  801ceb:	83 ec 0c             	sub    $0xc,%esp
  801cee:	50                   	push   %eax
  801cef:	e8 51 f2 ff ff       	call   800f45 <sys_ipc_recv>
  801cf4:	83 c4 10             	add    $0x10,%esp
  801cf7:	85 c0                	test   %eax,%eax
  801cf9:	78 2b                	js     801d26 <ipc_recv+0x57>
			*from_env_store=0;
		if(perm_store)
			*perm_store=0;
		return res;
	...
	if(from_env_store)
  801cfb:	85 f6                	test   %esi,%esi
  801cfd:	74 0a                	je     801d09 <ipc_recv+0x3a>
		*from_env_store=thisenv->env_ipc_from;
  801cff:	a1 04 40 80 00       	mov    0x804004,%eax
  801d04:	8b 40 74             	mov    0x74(%eax),%eax
  801d07:	89 06                	mov    %eax,(%esi)
	if(perm_store)
  801d09:	85 db                	test   %ebx,%ebx
  801d0b:	74 0a                	je     801d17 <ipc_recv+0x48>
		*perm_store=thisenv->env_ipc_perm;
  801d0d:	a1 04 40 80 00       	mov    0x804004,%eax
  801d12:	8b 40 78             	mov    0x78(%eax),%eax
  801d15:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  801d17:	a1 04 40 80 00       	mov    0x804004,%eax
  801d1c:	8b 40 70             	mov    0x70(%eax),%eax
}
  ...
  801d28:	74 06                	je     801d30 <ipc_recv+0x61>
			*from_env_store=0;
  801d2a:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801d30:	85 db                	test   %ebx,%ebx
  801d32:	74 eb                	je     801d1f <ipc_recv+0x50>
			*perm_store=0;
  801d34:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d3a:	eb e3                	jmp    801d1f <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d54:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801d59:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
  ...
  801d60:	56                   	push   %esi
  801d61:	57                   	push   %edi
  801d62:	e8 b7 f1 ff ff       	call   800f1e <sys_ipc_try_send>
		if(!res)
  801d67:	83 c4 10             	add    $0x10,%esp
  801d6a:	85 c0                	test   %eax,%eax
  801d6c:	74 20                	je     801d8e <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801d6e:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d71:	75 07                	jne    801d7a <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801d73:	e8 de ef ff ff       	call   800d56 <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801d78:	eb e2                	jmp    801d5c <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801d7a:	83 ec 04             	sub    $0x4,%esp
  801d7d:	68 56 25 80 00       	push   $0x802556
  801d82:	6a 3f                	push   $0x3f
  801d84:	68 6e 25 80 00       	push   $0x80256e
  801d89:	e8 b8 e4 ff ff       	call   800246 <_panic>
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801da5:	6b d0 7c             	imul   $0x7c,%eax,%edx
  801da8:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  801dae:	8b 52 50             	mov    0x50(%edx),%edx
  801db1:	39 ca                	cmp    %ecx,%edx
  801db3:	74 11                	je     801dc6 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801db5:	83 c0 01             	add    $0x1,%eax
  801db8:	3d 00 04 00 00       	cmp    $0x400,%eax
  801dbd:	75 e6                	jne    801da5 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801dbf:	b8 00 00 00 00       	mov    $0x0,%eax
  801dc4:	eb 0b                	jmp    801dd1 <ipc_find_env+0x3b>
			return envs[i].env_id;
  801dc6:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801dc9:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801dce:	8b 40 48             	mov    0x48(%eax),%eax
}
  801dd1:	5d                   	pop    %ebp
  801dd2:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801ddf:	c1 ea 16             	shr    $0x16,%edx
  801de2:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801de9:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801dee:	f6 c1 01             	test   $0x1,%cl
  801df1:	74 1c                	je     801e0f <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801df3:	c1 e8 0c             	shr    $0xc,%eax
  801df6:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801dfd:	a8 01                	test   $0x1,%al
  801dff:	74 0e                	je     801e0f <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e01:	c1 e8 0c             	shr    $0xc,%eax
  801e04:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801e0b:	ef 
  801e0c:	0f b7 d2             	movzwl %dx,%edx
}
