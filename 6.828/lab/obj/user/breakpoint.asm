...
sys_env_destroy(envid_t envid)
{
  ...
  80011a:	68 ea 1e 80 00       	push   $0x801eea
  80011f:	6a 23                	push   $0x23
  800121:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001a7:	68 ea 1e 80 00       	push   $0x801eea
  8001ac:	6a 23                	push   $0x23
  8001ae:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001ed:	68 ea 1e 80 00       	push   $0x801eea
  8001f2:	6a 23                	push   $0x23
  8001f4:	68 07 1f 80 00       	push   $0x801f07
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800233:	68 ea 1e 80 00       	push   $0x801eea
  800238:	6a 23                	push   $0x23
  80023a:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800279:	68 ea 1e 80 00       	push   $0x801eea
  80027e:	6a 23                	push   $0x23
  800280:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002bf:	68 ea 1e 80 00       	push   $0x801eea
  8002c4:	6a 23                	push   $0x23
  8002c6:	68 07 1f 80 00       	push   $0x801f07
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800305:	68 ea 1e 80 00       	push   $0x801eea
  80030a:	6a 23                	push   $0x23
  80030c:	68 07 1f 80 00       	push   $0x801f07
...
sys_ipc_recv(void *dstva)
{
  ...
  800371:	68 ea 1e 80 00       	push   $0x801eea
  800376:	6a 23                	push   $0x23
  800378:	68 07 1f 80 00       	push   $0x801f07
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800468:	ba 94 1f 80 00       	mov    $0x801f94,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  80048a:	51                   	push   %ecx
  80048b:	50                   	push   %eax
  80048c:	68 18 1f 80 00       	push   $0x801f18
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006f8:	53                   	push   %ebx
  8006f9:	50                   	push   %eax
  8006fa:	68 59 1f 80 00       	push   $0x801f59
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8007c9:	53                   	push   %ebx
  8007ca:	50                   	push   %eax
  8007cb:	68 75 1f 80 00       	push   $0x801f75
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800879:	53                   	push   %ebx
  80087a:	50                   	push   %eax
  80087b:	68 38 1f 80 00       	push   $0x801f38
...
fsipc(unsigned type, void *dstva)
{
  ...
  800971:	e8 21 12 00 00       	call   801b97 <ipc_send>
  ...
  80098f:	e8 5d 12 00 00       	call   801bf1 <ipc_find_env>
...
00800a4f <devfile_write>:
{
  ...
  800a61:	ba f8 0f 00 00       	mov    $0xff8,%edx
  800a66:	0f 47 c2             	cmova  %edx,%eax
	fsipcbuf.write.req_fileid = fd->fd_file.id;
  800a69:	8b 55 08             	mov    0x8(%ebp),%edx
  800a6c:	8b 52 0c             	mov    0xc(%edx),%edx
  800a6f:	89 15 00 50 80 00    	mov    %edx,0x805000
...
00800a99 <devfile_read>:
{
  ...
  800af2:	c3                   	ret    
	assert(r <= n);
  800af3:	68 a4 1f 80 00       	push   $0x801fa4
  800af8:	68 ab 1f 80 00       	push   $0x801fab
  800afd:	6a 7d                	push   $0x7d
  800aff:	68 c0 1f 80 00       	push   $0x801fc0
  800b04:	e8 be 05 00 00       	call   8010c7 <_panic>
	assert(r <= PGSIZE);
  800b09:	68 cb 1f 80 00       	push   $0x801fcb
  800b0e:	68 ab 1f 80 00       	push   $0x801fab
  800b13:	6a 7e                	push   $0x7e
  800b15:	68 c0 1f 80 00       	push   $0x801fc0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800be8:	68 d7 1f 80 00       	push   $0x801fd7
  800bed:	53                   	push   %ebx
...
00800c4c <_pipeisclosed>:
{
  ...
  800c64:	57                   	push   %edi
  800c65:	e8 c4 0f 00 00       	call   801c2e <pageref>
  ...
  800c8f:	50                   	push   %eax
  800c90:	53                   	push   %ebx
  800c91:	68 de 1f 80 00       	push   $0x801fde
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f46:	68 f6 1f 80 00       	push   $0x801ff6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010e7:	56                   	push   %esi
  8010e8:	50                   	push   %eax
  8010e9:	68 04 20 80 00       	push   $0x802004
  ...
  8010fa:	e8 5a 00 00 00       	call   801159 <vcprintf>
	cprintf("\n");
  8010ff:	c7 04 24 ef 1f 80 00 	movl   $0x801fef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801214:	e8 57 0a 00 00       	call   801c70 <__udivdi3>
  ...
  801252:	e8 29 0b 00 00       	call   801d80 <__umoddi3>
  801257:	83 c4 14             	add    $0x14,%esp
  80125a:	0f be 80 27 20 80 00 	movsbl 0x802027(%eax),%eax
  801261:	50                   	push   %eax
...
008012b1 <vprintfmt>:
{
  ...
  801301:	3e ff 24 85 60 21 80 	notrack jmp *0x802160(,%eax,4)
  801308:	00 
  ...
  8013ce:	8b 14 85 c0 22 80 00 	mov    0x8022c0(,%eax,4),%edx
  8013d5:	85 d2                	test   %edx,%edx
  8013d7:	74 18                	je     8013f1 <vprintfmt+0x140>
				printfmt(putch, putdat, "%s", p);
  8013d9:	52                   	push   %edx
  8013da:	68 bd 1f 80 00       	push   $0x801fbd
  8013df:	53                   	push   %ebx
  8013e0:	56                   	push   %esi
  ...
  8013f1:	50                   	push   %eax
  8013f2:	68 3f 20 80 00       	push   $0x80203f
  8013f7:	53                   	push   %ebx
  8013f8:	56                   	push   %esi
  ...
  801419:	b8 38 20 80 00       	mov    $0x802038,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801b83:	74 06                	je     801b8b <ipc_recv+0x61>
			*from_env_store=0;
  801b85:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if(perm_store)
  801b8b:	85 db                	test   %ebx,%ebx
  801b8d:	74 eb                	je     801b7a <ipc_recv+0x50>
			*perm_store=0;
  801b8f:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801b95:	eb e3                	jmp    801b7a <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ba7:	8b 75 0c             	mov    0xc(%ebp),%esi
  801baa:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 4: Your code here.
	if(!pg)
		pg=(void *)UTOP;
  801bad:	85 db                	test   %ebx,%ebx
  801baf:	b8 00 00 c0 ee       	mov    $0xeec00000,%eax
  801bb4:	0f 44 d8             	cmove  %eax,%ebx
	int res;
	while(1){
  ...
  801bbb:	56                   	push   %esi
  801bbc:	57                   	push   %edi
  801bbd:	e8 54 e7 ff ff       	call   800316 <sys_ipc_try_send>
		if(!res)
  801bc2:	83 c4 10             	add    $0x10,%esp
  801bc5:	85 c0                	test   %eax,%eax
  801bc7:	74 20                	je     801be9 <ipc_send+0x52>
			return;
		if(res!=-E_IPC_NOT_RECV)
  801bc9:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801bcc:	75 07                	jne    801bd5 <ipc_send+0x3e>
			panic("ipc_send:Not Receiving!");
		sys_yield();
  801bce:	e8 7b e5 ff ff       	call   80014e <sys_yield>
		res=sys_ipc_try_send(to_env,val,pg,perm);
  801bd3:	eb e2                	jmp    801bb7 <ipc_send+0x20>
			panic("ipc_send:Not Receiving!");
  801bd5:	83 ec 04             	sub    $0x4,%esp
  801bd8:	68 1f 23 80 00       	push   $0x80231f
  801bdd:	6a 3f                	push   $0x3f
  801bdf:	68 37 23 80 00       	push   $0x802337
  801be4:	e8 de f4 ff ff       	call   8010c7 <_panic>
	}
}
